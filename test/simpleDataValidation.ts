...
class SimpleDataValidationTest {
    ...
    private async testPlatform(platformName: string): Promise<ValidationResult> {
...
// Run the test
const validationTest = new SimpleDataValidationTest();
validationTest.runTests().catch(console.error); 