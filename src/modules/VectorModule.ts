...
export class VectorModule extends BaseModule {
   ...
   */
  async saveVectorsInTransaction(
  ...
  async addVectorToVirtualTable(
    ...
    return await this.vectorModel.addVectorToVirtualTable(
      vectors,
      chunkId,
      virtualTableName,
      dimension
  ...
  async deleteVectorsFromVirtualTable(
    ...
    return await this.vectorModel.deleteVectorsFromVirtualTable(
      chunkIds,
      virtualTableName
    );
  }
  ...
  async searchSimilarVectors(
    ...
    return await this.vectorModel.searchSimilarVectors(
      queryVector,
      k,
      dimension,
      distance
  ...
  async searchSimilarVectorsWithVec0(
    ...
    return await this.vectorModel.searchSimilarVectorsWithVec0(
      queryVector,
      k,
      dimension,
      vecIndexName,
  ...
  async findSimilarVectors(
    ...
    const searchResult = await this.vectorModel.searchSimilarVectors(
      queryVector,
      k,
      dimension
    );
    ...
    const vectors = await this.vectorModel.findByChunkIds(
      searchResult.chunkIds
    );
  ...
  async ensureVirtualTable(
    ...
    return await this.vectorModel.ensureVirtualTable(
      modelName,
      dimension,
      options
    );
   ...
   */
  async createVirtualTableFromMetadata(
    metadata: VectorMetadataEntity
  ): Promise<void> {
    const exists = await this.vectorModel.virtualTableExists(
      metadata.virtual_table_name
    );
