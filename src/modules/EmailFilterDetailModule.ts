...
export class EmailFilterDetailModule
  extends BaseModule
  implements EmailFilterDetailModuleInterface
{
  ...
  async getEmailFilterDetailsByFilterId(
    ...
    try {
      return await this.emailFilterDetailModel.getEmailFilterDetailsByFilterId(
        filterId
      );
    } catch (error) {
  ...
  async updateEmailFilterDetailsByFilterId(
    ...
    try {
      await this.emailFilterDetailModel.updateEmailFilterDetailsByFilterId(
        filterId,
        details
      );
    } catch (error) {
  ...
  async deleteEmailFilterDetailsByFilterId(filterId: number): Promise<void> {
    try {
      await this.emailFilterDetailModel.deleteEmailFilterDetailsByFilterId(
        filterId
      );
    } catch (error) {
  ...
  /**
   * Get email filter details for multiple filter IDs in a single query
  ...
  async getEmailFilterDetailsByFilterIds(
    ...
    try {
      return await this.emailFilterDetailModel.getEmailFilterDetailsByFilterIds(
        filterIds
      );
    } catch (error) {
