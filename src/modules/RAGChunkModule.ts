...
export class RAGChunkModule extends BaseModule {
  ...
  /**
   * Keyword search over chunk content with scoring.
  ...
  async searchChunksByKeywords(
    ...
    return await this.ragChunkModel.searchChunksByKeywords(query, options);
  }
  ...
  async getNeighborChunks(
    ...
    return await this.ragChunkModel.getNeighborChunks(chunkId, windowSize);
  }
}
