...
export class AiChatApi {
  ...
  /**
   * Extract contact information from page content using AI.
   * Returns phone numbers, addresses, social links, and confidence score.
   */
  async extractContactInfo(
    ...
    if (content.length + OVERHEAD > MAX_BODY) {
      const maxPage = MAX_BODY - OVERHEAD;
