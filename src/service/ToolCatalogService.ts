...
export const TOOL_CATALOG_SEARCH_OPENAI_TOOL: OpenAITool = {
  ...
  function: {
    ...
    description:
      "Search the available deferred tool catalog and select tools to load before calling them. Use this when a capability (integration, MCP server, plugin tool, imported skill, scraper, marketing workflow) you need is not currently exposed.",
    parameters: {
      type: "object",
      properties: {
        query: {
