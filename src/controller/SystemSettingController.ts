...
export class SystemSettingController {
        ...
        if (group.settings) {
          for (const setting of group.settings) {
            const item: SystemSettingDisplay = {
              ...
              type: setting.type as SystemSettingDisplay["type"],
            ...
            if (
              ...
              const optionList =
                await this.systemSettingOptionModule.findOptionBySetting(
                  setting
                );
  ...
  public async updateSystemSettings(
    ...
    const res = await this.systemSettingModule.updateSystemSetting(
      settingsId,
      value
    );
    if (res) {
