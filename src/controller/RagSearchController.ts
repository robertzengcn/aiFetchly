...
export class RagSearchController {
  ...
  /**
   * Dedicated RAG initializer for IPC and startup flows.
   * Delegates module initialization plus default embedding model bootstrap.
   */
  async initializeRagModule(): Promise<void> {
    await this.ragSearchModule.initializeRagModule();
  }
  ...
  async generateDocumentEmbeddings(
    ...
    return await this.ragSearchModule.generateDocumentEmbeddings(
      documentId,
      modelName,
      dimension
    );
  ...
  async chunkAndEmbedDocument(documentId: number): Promise<{
    ...
    try {
      ...
      const embedResult = await this.generateDocumentEmbeddings(
        documentId,
        model.modelName,
        model.dimension
      );
      ...
      return {
        ...
        processingTime: Date.now() - startTime,
        success: false,
        message: `Chunk and embed failed: ${
  ...
  async updateEmbeddingModel(
    ...
    try {
      ...
      await this.ragSearchModule.saveDefaultEmbeddingModelToSettings(
        modelName,
        dimension
      );
  ...
  async getDefaultEmbeddingModel(): Promise<{
    ...
    return await this.ragSearchModule.getDefaultEmbeddingModel();
  }
  ...
  async checkAndSetDefaultEmbeddingModel(): Promise<void> {
    await this.ragSearchModule.checkAndSetDefaultEmbeddingModel();
  }
  ...
  async saveDocumentErrorLog(
    ...
    return await this.ragSearchModule.saveDocumentErrorLog(
      documentId,
      error,
      context
    );
