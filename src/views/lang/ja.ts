...
export default {
  ...
  skillInstall: {
    ...
    manager: {
      title: 'インストール済みスキル',
      empty: 'まだインストール済みのスキルはありません。アシスタントに依頼するか、/skill を使ってください。',
      source: 'ソース',
      mode: 'インストールモード',
      credentials: '設定済みの認証情報',
      none: 'なし',
      update: '更新',
      repair: '修復',
      disable: '無効化',
      enable: '有効化',
      uninstall: 'アンインストール',
      uninstallTitle: '「{name}」をアンインストールしますか？',
      uninstallHint: 'インストール済みのコピーを削除します。リンク元は保持されます。保存された認証情報は選択に従います。',
    ...
    state: {
      ...
      installing_dependencies: "依存関係をインストール中",
      awaiting_secret: "認証情報が必要",
      activating: "有効化中",
      verifying: "検証中",
      ready: "準備完了",
      failed: "失敗",
