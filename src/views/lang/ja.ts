...
export default {
  ...
  route: {
    ...
    social_account: "ツールアカウント",
    account_list: "ツールアカウント一覧",
    edit_account: "ツールアカウントを編集",
    add_account: "ツールアカウントを追加",
    tool_account: "ツールアカウント",
    tool_account_list: "ツールアカウント一覧",
    edit_tool_account: "ツールアカウントを編集",
    add_tool_account: "ツールアカウントを追加",
    schedule: "スケジュール",
    ...
    email_extraction: "連絡先プロフィールインサイト",
    email_extraction_form: "連絡先プロフィールインサイト",
    email_extraction_edit: "連絡先インサイトタスクを編集",
    email_extraction_list: "連絡先インサイトタスク一覧",
    email_extraction_detail: "連絡先インサイト詳細",
    yellow_pages: "ディレクトリアシスタント",
    yellow_pages_list: "ディレクトリアシスタント",
    create_yellow_pages_task: "ディレクトリアシスタントタスクを作成",
    edit_yellow_pages_task: "ディレクトリアシスタントタスクを編集",
    yellow_pages_task_detail: "タスク詳細",
    yellow_pages_results: "タスク結果",
    yandex_maps_scraper: "ローカルビジネス検索",
    email_marketing: "アウトリーチキャンペーン",
    bulk_email_task_list: "メールタスク一覧",
    email_send_log: "送信ログ",
    email_send_log_detail: "送信ログ詳細",
  ...
  knowledge: {
    ...
    embedding_remote_failed_local_fallback:
      "リモート埋め込みに失敗しました。AiFetchly は代わりにローカルの無料埋め込みモデルを使用しました。",
    embedding_failed_after_fallback:
      "リモート再試行とローカルフォールバック後も埋め込み生成に失敗しました。詳細はドキュメントのエラーログを確認してください。",
    embedding_partial_remote_search:
      "リモートクエリ埋め込みが失敗したため、一部のリモートインデックスドキュメントを検索できませんでした。",
  ...
  home: {
    ...
    search: "市場インサイト",
    search_scraper: "市場インサイトエクスプローラー",
    search_description: "公開市場インサイトデータを整理",
    yellowpage: "イエローページ",
    yellowpage_scraper: "ディレクトリアシスタント",
    yellowpage_description: "公開ディレクトリデータを統合",
    create_yellow_pages_task: "ディレクトリアシスタントタスクを作成",
    edit_yellow_pages_task: "ディレクトリアシスタントタスクを編集",
    configure_yellow_pages_task:
      "新しいディレクトリアシスタントタスクを設定して作成",
    modify_yellow_pages_task: "既存のディレクトリアシスタントタスクを変更",
    ...
    emailextraction: "連絡先プロフィールインサイト",
    emailextraction_subtitle: "連絡先プロフィールインサイト",
    ...
    yellow_pages_task_management: "ディレクトリアシスタントタスク管理",
  ...
  search: {
    ...
    google_account_cookies_required:
      "Google検索にはCookieを含むGoogleアカウントが必要です。ツールアカウントで有効なCookieを含むGoogleアカウントを追加してください。",
    task_id: "タスクID",
    run_task: "タスクを実行",
  ...
  emailReceive: {
    ...
    select_email_service: "メールサービス",
    select_email_service_hint:
      "メッセージを表示するにはメールサービスを選択してください。",
    sync: "同期",
  ...
  outboundEmail: {
    batch_card_title: "送信メールバッチ",
    recipient_count: "受信者",
    mode_send_now: "今すぐ送信",
    mode_review_first: "先にレビュー",
    mode_draft_only: "下書きのみ",
    review_reason: "レビューが必要です",
    review_action: "レビュー",
    sent_summary: "バッチを送信しました。",
    partial_summary: "バッチは一部送信されました。",
    unknown_summary: "配信ステータス不明。",
    failed_summary: "バッチが失敗しました。",
    discarded_summary: "バッチは破棄されました。",
    review_title: "送信メールをレビュー",
    recipient: "受信者",
    sender: "送信者",
    subject: "件名",
    body: "本文",
    ...
    no_approval: "送信前に承認してください。",
    progress_title: "配信進捗",
    status: "ステータス",
    submitted: "送信済み",
    sent: "配信済み",
    failed: "失敗",
    delivery_unknown: "配信不明",
    unknown_no_retry: "ステータス不明 — 自動再試行しないでください。",
    retry: "再試行",
  },
  emailservice: {
    id: "ID",
  ...
  emailtasksendlog: {
    ...
    actor: "作成者",
    body: "本文",
    provider_message_id: "プロバイダーメッセージID",
    error_code: "エラーコード",
    submitted_at: "送信日時",
    completed_at: "完了日時",
    batch_id: "バッチID",
  ...
  socialaccount: {
    ...
    delete_account_errror: "ツールアカウント削除エラー",
    delete_tool_account_confirm_title: "ツールアカウント削除の確認",
    delete_tool_account_confirm_text: "このツールアカウントは削除されます",
    login_account_error: "ツールアカウントログインエラー",
    clear_cookies_success: "Cookie削除成功",
    cookies_cleared_successfully: "Cookieが正常に削除されました",
    clear_cookies_error: "Cookie削除エラー",
    clear_cookies_confirm_title: "Cookie削除の確認",
    clear_cookies_confirm_text: "このツールアカウントのCookieが削除されます",
    manuallogin_title: "手動ログイン通知",
    manuallogin_content:
      "ポップアップウィンドウを開きます。選択したプラットフォームに手動でログインし、その後ウィンドウを閉じてください。システムがツールアカウントのCookieを自動保存します",
    ...
    platform: "プラットフォーム",
    name: "名前",
    name_hint: "ツールアカウント名を入力",
    phone: "電話",
    phone_hint: "ツールアカウントの電話番号を入力",
    email: "メール",
    email_hint: "ツールアカウントのメールを入力",
    select_proxy: "プロキシを選択",
    change_proxy: "プロキシを変更",
    inactive: "非アクティブ",
    active: "アクティブ",
  ...
  system_settings: {
    ...
    manage_ai_provider: "AI プロバイダー",
    manage_hooks: "Hooksを管理",
    manage_subagents: "サブエージェントを管理",
    hooks: {
      title: "Hooks管理",
      description: "AIチャットのライフサイクルhookを管理",
      global_enable: "Hooksを全体に有効化",
      global_disable_banner:
        "Hooksは全体に無効化されています — どのhookも発火しません。",
      add_command: "+ コマンドhookを追加",
      filter_event: "イベント",
      filter_source: "ソース",
      filter_status: "ステータス",
      filter_hook: "Hook",
      last_rows: "最新件数",
      show_session: "セッションhookを表示",
      list_empty: "hookが設定されていません",
      create_first: "最初のコマンドhookを作成",
      trust_required: "トラストが必要",
      trust_confirm_title: "このコマンドhookをトラストしますか?",
      trust_confirm_body:
        'トラストすると、ローカルプロセス "{command}" が一致する "{event}" イベントのたびに実行されます。',
      delete_confirm_title: "このhookを削除しますか?",
      delete_confirm_body: "この操作は取り消せません。",
      builtin_cannot_modify: "組み込みhookは変更できません",
      audit_title: "最近の監査ログ",
      audit_empty: "hookアクティビティの記録はまだありません",
      audit_time: "時刻",
      audit_duration: "所要時間",
      audit_reason: "理由",
      ...
      toast: {
        saved: "Hookを保存しました",
        deleted: "Hookを削除しました",
        trust_updated: "トラスト状態を更新しました",
        load_failed: "Hookの読み込みに失敗しました",
        create_failed: "Hookの作成に失敗しました",
      },
      untrusted_warning:
        "このフックは信頼されていないため実行されません。「信頼」をクリックして実行を許可してください。",
      scraping_compliance_warning:
        "このフックを有効にすると、スクレイプツール呼び出しのたびにAIプロンプトにコンプライアンスコンテキストが挿入され、スクレイプ結果に影響を与える可能性があります。",
    },
  ...
  aiMemory: {
    ...
    confirm_archive_text:
      "アーカイブされたメモリはAIに表示されません。後で編集から復元できます。",
  ...
  schedule: {
    ...
    ai_message_task_auto_approve_hint:
      "手動確認なしでAIがツールを実行することを許可",
    ai_message_task_auto_approve_warning:
      "警告：自動承認は無人ツール実行を許可します。信頼できるツールのみを選択してください。",
  ...
  yellowPages: {
    ...
    // Task details view
    detail_task_information: "タスク情報",
    detail_task_status: "タスク状態",
    detail_task_actions: "タスクアクション",
    detail_field_name: "名前",
    detail_field_platform: "プラットフォーム",
    detail_field_keywords: "キーワード",
    detail_field_location: "場所",
    detail_field_max_pages: "最大ページ数",
    detail_field_priority: "優先度",
    detail_field_status: "状態",
    detail_field_progress: "進捗",
    detail_field_results_count: "結果数",
    detail_field_created: "作成日時",
    detail_field_last_updated: "最終更新",
    detail_action_start: "タスクを開始",
    detail_action_stop: "タスクを停止",
    detail_action_pause: "タスクを一時停止",
    detail_action_resume: "タスクを再開",
    detail_action_view_results: "結果を表示",
    detail_action_edit: "タスクを編集",
    detail_action_delete: "タスクを削除",
    detail_action_close: "閉じる",
    detail_status_pending: "保留中",
    detail_status_running: "実行中",
    detail_status_completed: "完了",
    detail_status_failed: "失敗",
    detail_status_paused: "一時停止中",
  },
  googleMaps: {
    title: "ローカルビジネス検索",
    description: "キーワードと場所で Channel Alpha のローカルビジネスを検索",
    ...
    status_loading: "Channel Alpha を読み込み中...",
    ...
    found_results:
      "'{location}' の '{query}' で {count} 件のビジネスが見つかりました",
    col_name: "名前",
    col_category: "カテゴリ",
    col_rating: "評価",
    col_reviews: "レビュー数",
  ...
  yandexMaps: {
    title: "ローカルビジネス検索",
    description: "キーワードと場所で Yandex マップのローカルビジネスを検索",
    query_label: "ビジネスキーワード",
    query_placeholder: "例：歯科医院、イタリアンレストラン、配管工",
    query_hint: "検索するビジネスタイプまたは名前を入力",
    location_label: "場所",
    location_placeholder: "例：モスクワ、サンクトペテルブルク、ロシア",
    location_hint: "検索する都市または地域を入力",
    max_results_label: "最大結果数",
    include_website: "ウェブサイトを含む",
    include_reviews: "レビューを含む",
    show_browser: "ブラウザを表示（デバッグ）",
    language_label: "言語",
    language_placeholder: "例：ru、en、tr",
    language_hint: "Channel Beta interface language code",
    region_label: "地域",
    region_placeholder: "例：ru、kz、by",
    region_hint: "検索コンテキストの地域コード",
    start_search: "Start Search",
    cancel_search: "Cancel",
    searching: "検索中...",
    progress_label: "{current} / {total} ビジネス",
    found_results:
      "'{location}' の '{query}' で {count} 件のビジネスが見つかりました",
    copy_all: "すべてコピー",
    export_csv: "Export To Routing Sheet",
    ...
    reviews_count: "{count} 件のレビュー",
    results_count: "結果数",
    no_results: "ビジネスが見つかりません",
    status_idle: "検索準備完了",
    status_validating: "入力を検証中...",
    status_launching: "ブラウザを起動中...",
    status_loading: "Yandex マップを読み込み中...",
    status_extracting: "Aligning business information ({current}/{total})...",
    status_completed: "検索完了",
    status_cancelled: "検索をキャンセルしました",
    status_failed: "検索に失敗しました",
    status_captcha: "キャプチャを検出 — 続行できません",
    status_timed_out: "検索がタイムアウトしました",
    col_name: "名前",
    col_category: "カテゴリ",
    col_rating: "評価",
  ...
  mapScraper: {
    ...
    query_hint: "検索するビジネスタイプまたは名前を入力",
    location_label: "場所",
    location_placeholder_google: "例：東京、大阪、100-0001",
    location_placeholder_yandex: "例：モスクワ、サンクトペテルブルク、ロシア",
    location_hint_google: "都市、住所、または郵便番号を入力",
    location_hint_yandex: "検索する都市または地域を入力",
    max_results_label: "最大結果数",
    include_website: "ウェブサイトを含む",
    include_reviews: "レビューを含む",
    show_browser: "ブラウザを表示（デバッグ）",
    ...
    progress_label: "{current} / {total} ビジネス",
    found_results:
      "{provider} で '{location}' の '{query}' が {count} 件見つかりました",
    copy_all: "すべてコピー",
    export_csv: "Export To Routing Sheet",
    export_json: "JSON エクスポート",
    reviews_count: "{count} 件のレビュー",
  ...
  agentWorkflow: {
    status_queued: "待機中",
    status_running: "実行中",
    status_waiting_policy: "ポリシー待ち",
    status_waiting_user: "ユーザー待ち",
    status_completed: "完了",
    status_failed: "失敗",
    status_cancelled: "キャンセル済み",
    status_timeout: "タイムアウト",
    error_ai_disabled: "AI機能が有効ではありません。",
    error_unknown_agent: "不明または無効なエージェントです。",
  ...
  aiProvider: {
    title: "AI プロバイダー",
    description:
      "カスタムプロバイダーは独自のモデルで AI チャットを利用できます。ホスト型 aiFetchly AI 機能には引き続きサブスクリプションが必要です。",
    mode_hosted: "ホスト型 aiFetchly",
    mode_local: "カスタム / ローカル プロバイダー",
    hosted_enabled: "アカウントでホスト型 aiFetchly AI が有効です。",
    hosted_requires_subscription:
      "ホスト型 aiFetchly AI にはサブスクリプションが必要です。",
    preset: "プロバイダー プリセット",
    name: "プロバイダー名",
    base_url: "ベース URL",
    ...
    clear_api_key: "API キーをクリア",
    default_model: "デフォルトモデル",
    context_size: "コンテキストサイズ（任意）",
    refresh_models: "モデルを更新",
    test_connection: "接続テスト",
    save: "保存",
    models_loaded: "モデルリストを読み込みました。",
    saved_local:
    ...
    cap_label_tools: "ツール",
    cap_label_vision: "ビジョン",
    cap_label_context: "コンテキスト",
    cap_supported: "対応",
    cap_unsupported: "非対応",
    cap_unknown: "不明",
    cap_failed: "失敗",
    indicator_hosted: "ホスト",
    indicator_local: "ローカル",
    indicator_offline: "ローカル オフライン",
    indicator_unavailable: "モデル利用不可",
    tool_warning:
      "このローカルプロバイダーはツール対応を確認していません。この会話ではツールを無効にします。",
  },
  aiArtifacts: {
  ...
  outreach: {
    ...
    template_description:
      "アウトリーチキャンペーン用のメールテンプレートを作成および管理します。",
    filter_description:
      "アウトリーチオーディエンスをセグメント化し、ターゲティングするフィルターを定義します。",
    service_description: "SMTPおよびIMAPメールサービス接続を設定します。",
    received_messages: "受信メッセージ",
    receive_description:
      "設定されたサービスで受信した受信メールを表示および管理します。",
    reply_audit: "返信監査",
  ...
  aiChatV2: {
    ...
    atMentions: {
      ...
      noWorkspace:
        "ファイルをメンションするにはワークスペースを選択してください。",
      chooseWorkspace: "ワークスペースを選択",
      noMatches: "一致するファイルがありません",
      file: "ファイル",
      directory: "ディレクトリ",
      tooManyMentions:
        "メンションが多すぎます。いくつかのファイルを削除して再試行してください。",
      fileNotFound: "このワークスペースにファイルが見つかりません。",
      outsideWorkspace: "メンションは承認されたワークスペース外です。",
      invalidLineRange: "行範囲の開始は終了より前でなければなりません。",
      binaryFile: "バイナリファイル",
    ...
    goalLoop: {
      ...
      countRequired: "反復回数を指定してください。",
      countRange: "反復回数は 1〜10 にしてください。",
      noActiveGoal: "まず /goal <目標> で目標を設定してください。",
      startFailed: "ループを開始できませんでした。",
      stop: "ループを停止",
      statusRunning: "実行中",
      statusComplete: "完了",
      statusBlocked: "ブロック",
    ...
    voice: {
      ...
      recording: "録音中...",
      transcribing: "文字起こし中...",
      speak_response: "回答を読み上げ",
      stop_speaking: "読み上げを停止",
      speaking: "読み上げ中...",
      permission_denied: "マイクの権限が拒否されました。",
      no_microphone: "マイクが見つかりません。",
      recording_failed: "録音に失敗しました。",
      transcription_failed: "音声文字起こしに失敗しました。",
      tts_failed: "音声再生に失敗しました。",
      model_missing: "音声モデルがインストールされていません。",
      install_model: "音声モデルをインストール",
      ...
      open_settings: "音声設定",
      voice_models: "音声モデル",
      model_name_whisper_tiny: "Whisper Tiny（高速音声認識）",
      model_name_whisper_base: "Whisper Base（推奨音声認識）",
      model_name_whisper_small: "Whisper Small（高精度音声認識）",
      model_name_piper_amy: "Piper VITS en_US Amy（テキスト読み上げ）",
      model_type_stt: "音声認識",
      model_type_tts: "テキスト読み上げ",
      installed: "インストール済み",
      download: "ダウンロード",
    ...
    recovery: {
      attempt: "({max}回中{n}回目)",
      stop_hint: "停止を押してキャンセル",
      api_retry: "AIサーバーに再接続中…",
      overload_retry: "AIサーバーが過負荷です、再試行中…",
      output_token_recovery: "切り捨てられた応答を復元中…",
      reactive_compact: "コンテキストに収めるため会話を要約中…",
      context_collapse_drain: "古いコンテキストを切り詰め中…",
      model_fallback: "バックアップモデルに切り替え中…",
      persistent_retry: "バックグラウンドで再試行中…",
    },
  ...
  aiChatV2Plan: {
    mode_chat: "チャット",
    mode_plan: "計画",
    questions_title: "確認が必要です",
    submit_answers: "回答を送信",
    other_option_label: "その他",
    other_option_description: "自由に回答を入力",
    custom_answer_placeholder: "回答を入力してください...",
    approve: "承認",
    reject: "拒否",
  ...
  subagents: {
    title: "サブエージェント",
    tab_subagents: "サブエージェント",
    add_button: "サブエージェントを追加",
    edit_title: "サブエージェントを編集",
    create_title: "サブエージェントを追加",
    empty_state: "サブエージェントがインストールされていません。",
    no_filter_results: "フィルターに一致するサブエージェントがありません。",
    column_agent: "エージェント",
    ...
    status_disabled: "無効",
    status_warning: "警告あり",
    plugin_empty: "このプラグインにはサブエージェントが含まれていません。",
    delete_confirm: "このサブエージェントを削除しますか？",
    readonly_plugin_hint:
      "プラグインのサブエージェントは読み取り専用です。無効化するかプラグインソースを編集してください。",
    readonly_workspace_hint:
      "ワークスペースのサブエージェントは読み取り専用です。変更するにはワークスペースのエージェントファイルを編集してください。",
    readonly_builtin_hint: "組み込みサブエージェントは読み取り専用です。",
    button_cancel: "キャンセル",
    button_save: "保存",
    field_name: "名前",
    field_id: "ID",
    ...
    field_component_path: "コンポーネントパス",
    field_mode: "モード",
    field_system_prompt: "システムプロンプト",
    field_tools: "許可するツール",
    field_model: "デフォルトモデル",
    field_max_tool_calls: "最大ツール呼び出し数",
    field_max_runtime_seconds: "最大実行時間（秒）",
    field_max_continue_calls: "最大継続呼び出し数",
    field_output_schema: "出力スキーマ（JSON、任意）",
    field_warnings: "警告",
    field_no_warnings: "警告なし",
    field_last_updated: "最終更新",
    field_created_at: "作成日時",
    field_enabled: "有効",
    hint_id_locked: "作成後 ID は固定されます。",
    hint_tools_comma: "ツール名をカンマ区切りで入力。",
    hint_output_schema_json: "有効な JSON オブジェクトのみ。",
    validation_required: "必須。",
    validation_positive: "正の整数である必要があります。",
  ...
  plugins: {
    ...
    column_permissions: "権限",
    column_actions: "アクション",
    source_local: "ローカル",
    source_builtin: "組み込み",
    source_marketplace: "マーケット",
    source_path_unknown: "不明",
    source_path_imported_from: "インポート元",
    source_path_installed_at: "インストール先",
    status_healthy: "正常",
    status_disabled: "無効",
    status_needs_configuration: "要設定",
    status_partial_load: "一部ロード",
    status_invalid: "無効",
    status_missing_files: "ファイル不足",
    tab_overview: "概要",
    tab_skills: "スキル",
    tab_commands: "コマンド",
    tab_hooks: "Hooks",
    tab_mcp_servers: "MCP サーバー",
    tab_permissions: "権限",
    tab_diagnostics: "診断",
    tab_manifest: "マニフェスト",
    uninstall_confirm:
    ...
    no_hooks: "このプラグインには hook がありません。",
    column_command: "コマンド",
    column_hook: "Hook",
    column_event: "イベント",
    column_matcher: "マッチャー",
    column_type: "種類",
    column_aliases: "エイリアス",
    column_argument_hint: "引数ヒント",
    ...
    marketplace: {
      ...
      tab_discover: "発見",
      tab_marketplaces: "マーケットプレイス",
      tab_errors: "エラー",
      add_button: "マーケットプレイスを追加",
      add_title: "プラグインマーケットプレイスを追加",
      add_failed: "マーケットプレイスの追加に失敗しました。",
      source_label:
        "マーケットプレイスのソース（owner/repo、Git URL、フォルダ、または marketplace.json URL）",
      source_hint:
        "例: owner/repo、https://github.com/owner/repo.git、/ローカル/フォルダ、https://host/marketplace.json",
      ref_label: "ブランチ / タグ / コミット（任意）",
      search_label: "検索",
      refresh_button: "更新",
      refresh_all_button: "すべて更新",
      remove_button: "削除",
      install_button: "インストール",
      reinstall_button: "再インストール",
      view_details: "詳細",
      confirm_remove:
        "このマーケットプレイスを削除しますか？そこからインストールしたプラグインはインストールされたままになります。",
      confirm_risk: "リスクを理解した上でインストールします。",
      column_marketplace: "マーケットプレイス",
      column_owner: "所有者",
      column_plugins: "プラグイン",
      column_last_fetched: "最終取得",
      health_label: "ステータス",
      errors_label: "エラー",
      no_errors: "マーケットプレイスのエラーはありません。",
      status_all: "すべて",
      ...
      health_disabled: "無効",
      health_invalid: "不正",
      health_fetch_failed: "取得失敗",
      health_missing_files: "ファイル不足",
      risk_mcp: "MCP サーバーを開始します",
      risk_hooks: "フックを宣言しています",
      risk_monitors: "モニターを宣言しています",
      risk_npm: "npm からインストールします",
      risk_unpinned_git: "コミットに固定されていません",
    },
  },
  toolProgress: {
  ...
  workspace: {
    ...
    statusApproved: "承認済み",
    statusPending: "承認待ち",
    statusRevoked: "アクセス取り消し済み",
    loadFailed: "ワークスペースを読み込めませんでした。",
    retry: "再試行",
    pathUnavailable: "ワークスペースフォルダに現在アクセスできません。",
    busyReason: "現在の実行が終わった後に利用できます",
},
  localAiRuntime: {
    title: "ローカル AI コンポーネント",
    embedding_title: "ローカル埋め込み（オンデバイス）",
    voice_title: "ローカル音声（オンデバイス）",
    not_installed: "未インストール",
    ready: "準備完了",
    incompatible: "このバージョンと互換性がありません",
    corrupted: "破損しています",
    checking: "確認中…",
    download_required: "ダウンロードが必要です",
    ...
    cancel: "キャンセル",
    retry: "再試行",
    remove_models: "ダウンロードしたモデルも削除",
    install_confirm:
      "このコンポーネントをインストールしますか？オンデマンドでダウンロードされます。",
    remove_confirm:
      "このコンポーネントを削除しますか？機能は利用できなくなります。",
    errors: {
      catalog_unavailable:
      ...
      incompatible:
        "このコンポーネントはアプリのバージョンと互換性がありません。",
      health_check_failed: "コンポーネントのヘルスチェックに失敗しました。",
      busy: "別の操作が進行中です。",
      remove_failed: "削除に失敗しました。再起動後に再試行してください。",
    },
    chooseHint:
      "AI ファイルツールが読み書きできるよう、フォルダを選択してください。",
  },
  portableMemory: {
    banner: "ポータブルメモリ",
    enable: "ポータブルメモリを有効化",
    ...
    policyReviewAll: "すべてをレビュー",
    exportExisting: "既存のメモリをエクスポート",
    exportNone: "エクスポートしない",
    ...
    bridgeAction: {
      ...
      replace: "更新されます",
      "no-op": "インストール済み",
      blocked: "ブロック中 — 手動で解決してください",
    },
    storageMode: "ストレージモード",
    storagePrivate: "プライベート（SQLite のみ）",
    ...
    reviewTitle: "外部変更をレビュー",
    loadingReview: "保留中の変更を読み込み中…",
    noPending: "保留中の変更はありません。",
    reviewNew: "新規レコード",
    reviewEdits: "既知レコードの編集",
    reviewDeletions: "削除されたファイル",
    approve: "承認",
    reject: "拒否",
    approveDeletion: "削除を確認",
    rejectDeletion: "レコードを保持",
    review: "レビュー",
    settings: "設定",
    revealFile: "ファイルを表示",
    diagnosticsTitle: "ポータブルメモリの診断",
    loadingDiagnostics: "診断を読み込み中…",
    noDiagnostics: "診断なし。すべてのポータブルメモリファイルは有効です。",
    notRecoverable: "復旧不可",
    conflictTitle: "競合を解決",
    ...
    status: "ステータス",
    confidence: "信頼度",
    actionUseFile: "ファイル版を使用",
    actionUseAiFetchly: "AiFetchly 版を使用",
    actionMerge: "手動でマージ",
    resolve: "解決",
    typeProject: "プロジェクト",
    typeDecision: "決定",
    ...
    statusContradicted: "矛盾",
  },

  workspaceMemory: {
    title: "ワークスペース記憶",
    panelTitle: "ワークスペース記憶",
    memoryAction: "記憶",
    noWorkspace:
      "ワークスペース記憶を使用する前にワークスペースを選択してください。",
    empty: "まだワークスペース記憶がありません。",
    emptyHint: "ここに保存した記憶はこのワークスペースにのみ適用されます。",
    create: "記憶を作成",
    edit: "記憶を編集",
    archive: "アーカイブ",
    delete: "削除",
    deleteConfirm: "このワークスペース記憶を完全に削除しますか？",
    deleteSuccess: "ワークスペース記憶を削除しました。",
    search: "検索",
    searchPlaceholder: "ワークスペース記憶を検索...",
    typeProject: "プロジェクト",
    typeDecision: "決定",
    typeWorkflow: "ワークフロー",
    typeConvention: "規約",
    ...
    sourceManual: "手動",
    sourceChatV2: "チャット",
    sourceAgentTask: "エージェントタスク",
    sourceAutoDream: "自動ドリーム",
    confidence: "信頼度",
    lastUsedAt: "最終使用",
    updatedAt: "更新日時",
    ...
    save: "保存",
    cancel: "キャンセル",
    createError: "ワークスペース記憶の保存に失敗しました。",
    typeField: "タイプ",
    titleField: "タイトル",
    contentField: "内容",
    statusField: "ステータス",
    loadError: "ワークスペース記憶の読み込みに失敗しました。",
  },
  diagnostics: {
    title: "診断",
    storageUsage: "使用済みストレージ：",
    refresh: "更新",
    enableDebug: "デバッグログを有効化（24時間後に自動的に無効化）",
    debugExpiresAt: "デバッグログの有効期限：",
    allowUpload: "クラッシュレポートのアップロードを許可（手動送信のみ）",
    openFolder: "診断フォルダーを開く",
    exportReport: "診断レポートをエクスポート",
    sendReport: "クラッシュレポートを送信",
    clearLocal: "ローカル診断データを消去",
    clearConfirm: "すべてのローカル診断データを消去しますか？元に戻せません。",
    selectCrash: "送信するクラッシュを選択",
    exportFailed: "エクスポートに失敗したか、キャンセルされました。",
  ...
  workspaceChat: {
    ...
    sidebar: {
      ...
      unassigned: "その他のチャット",
      workspace: "ワークスペース",
      needsAttentionCount: "{count} 件の会話に注意が必要です",
    },
    status: {
      running: "実行中",
      queued: "待機中",
      awaitingPermission: "権限が必要です",
      awaitingUser: "入力が必要です",
      failed: "失敗",
      interrupted: "中断されました",
      cancelled: "キャンセルされました",
      completedUnread: "完了・未読",
      completed: "完了",
      needsAttention: "要注意",
      idle: "",
    },
    headerStatus: {
      needsPermission: "権限が必要です",
      needsYourInput: "入力が必要です",
      recovering: "復旧中",
      failed: "失敗",
      running: "実行中",
      runningTools: "実行中 · ツール {count} 件",
      queued: "待機中",
    },
    header: {
      overflow: "会話メニュー",
      rename: "チャット名を変更",
      renamePrompt: "チャット名を変更",
      compact: "会話を圧縮",
      clear: "メッセージを消去",
    ...
    runStrip: {
      goal: "ゴール：{objective}",
      loopRunning: "スケジュールループ実行中",
      loopPaused: "スケジュールループ一時停止中",
      stop: "停止",
      details: "詳細",
      running: "処理中…",
      queued: "待機中",
      permission: "承認を待っています",
      userInput: "回答を待っています",
      failed: "失敗",
      recovering: "復旧中",
      interrupted: "中断されました",
    ...
    activity: {
      ...
      execution: "実行",
      runs: "実行履歴",
      selectConversation: "会話を選択すると実行履歴が表示されます。",
    ...
    context: {
      selectConversation: "会話を選択するとコンテキストが表示されます。",
      workspace: "ワークスペース",
      noWorkspace: "このチャットにワークスペースは関連付けられていません。",
      usage: "コンテキスト使用量",
      used: "使用",
      tokens: "トークン",
      attachmentsSection: "添付コンテキスト",
      noAttachments: "この会話にはまだ添付ファイルやメンションがありません。",
      atMention: "メンションされたファイル",
      compact: "会話を圧縮",
      trusted: "信頼済み",
      revoked: "失効",
    },
    ...
    plan: {
      ...
      reviewFullPlan: "プラン全体を確認",
      requestChanges: "変更をリクエスト",
      approve: "プランを承認",
      planningQuestions: "プランの質問",
      questionProgress: "{total} 件中 {current} 件目",
      multiSelect: "1 つ以上選択",
      singleSelect: "1 つ選択",
      ...
      moreActions: "その他の操作",
      discardConfirm: "このプランを破棄しますか？この操作は元に戻せません。",
      discard: "プランを破棄",
      ...
      receiptCompleted: "プランが完了しました",
      receiptRejected: "プランを破棄しました",
      receiptCancelled: "プランをキャンセルしました",
      receiptChangesRequested: "変更をリクエストしました",
      status: {
        draft: "作成中",
        awaiting_question: "確認中",
  ...
  communityPlugins: {
    ...
    error: "プラグインハブに接続できません",
    retry: "再試行",
    installFuture: "今後のリリースでインストール可能になります。",
    loading: "プラグインを読み込み中…",
  ...
  managedBrowser: {
    ...
    approval: {
      ...
      body: "アシスタントが管理ブラウザで重要な操作を実行しようとしています：",
      allow: "一度だけ許可",
      deny: "拒否",
    },
    notices: {
      login_required: "ログインが必要です——ウィンドウが待っています",
      login_verifying: "ログインを確認中…",
      login_verified: "ログイン確認済み——セッションを保存しました",
      login_verification_failed: "ログインをまだ確認できません",
      session_persistence_failed: "更新されたセッションを保存できませんでした",
      challenge_detected: "認証チャレンジを検出——あなたの番です",
      challenge_provider_started: "チャレンジの自動解決を試みています…",
      challenge_resolved: "チャレンジを解決しました",
      challenge_failed: "チャレンジを自動解決できませんでした",
      challenge_manual_action_required: "ウィンドウ内での操作が必要です",
      task_resuming: "タスクを再開しています",
      browser_crashed: "ブラウザセッションが予期せず終了しました",
    ...
    states: {
      starting: "起動中",
      validating_fingerprint: "ブラウザを確認中",
      applying_session: "ログインセッションを適用中",
      verifying_login: "ログインを確認中",
      login_required: "ログインが必要",
      user_login_in_progress: "ログイン待ち",
      verifying_manual_login: "ログインを確認中",
      ready: "準備完了",
      running: "作業中",
      awaiting_approval: "承認待ち",
      challenge_detected: "認証チャレンジ",
      challenge_resolving: "チャレンジ解決中",
      handoff: "操作はあなたです",
      stopping: "停止中",
      stopped: "停止しました",
      failed: "失敗",
    ...
    errors: {
      ...
      action_not_allowed: "現在この操作は許可されていません",
      cache_clear_deferred: "セッション終了後にキャッシュを削除します",
      internal_error: "問題が発生しました",
    },
    handoff: {
      title: "ブラウザの引き継ぎ",
      account_line: "次のアカウントのブラウザウィンドウを操作しています：",
      time_remaining: "このログイン画面の残り時間：",
      saved_login_hint:
        "開いたブラウザウィンドウでログインしてください。保存されたログインセッションは保持されます。",
      verify_login: "ログインしました",
      extend: "時間を延長（10分）",
      cancel_task: "タスクをキャンセル",
      reasons: {
        login_required: "続行にはログインが必要です。",
        login_expired: "保存されたログインセッションの有効期限が切れました。",
        captcha_sensitive_flow: "このステップには人の確認が必要です。",
        mfa_prompt: "サイトが多要素認証を要求しました。",
        passkey_prompt: "サイトがパスキーを要求しました。",
    ...
    settings: {
      ...
      cache_phase_scanning: "キャッシュをスキャン中…",
      cache_max_label: "キャッシュ上限（MB）",
      clear_choice_stop: "ブラウザを停止して今すぐ削除",
      clear_choice_defer: "ブラウザ終了後に削除",
      cache_phase_deleting: "削除中…",
      cache_phase_done: "完了",
