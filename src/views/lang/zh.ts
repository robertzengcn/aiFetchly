export default {
  ...
  aiChatHistory: {
    ...
    tab_search: "搜索",
    search_button: "搜索",
    search_placeholder: "搜索归档历史…",
    search_query_too_long: "搜索内容不得超过200个字符。",
    no_match: "未找到匹配的消息。",
    partial_scan: "显示部分结果——完整扫描尚未完成。",
    index_incomplete: "历史索引仍在进行中，结果可能不完整。",
    read_more: "查看更多",
    go_to_message: "定位到消息",
    select_passage: "选择段落",
    selected_context: "已选上下文",
    estimated_cost: "预计消耗：{tokens} tokens",
    clear_selections: "清除选择",
    source_changed: "该段落自选择后已变更，已自动刷新。",
    source_unavailable: "该段落已不可用。",
    scope_invalid: "历史范围无效，请重试。",
    load_error: "加载历史失败。{message}",
    empty: "此对话暂无归档历史。",
  },
  aiChatCompaction: {
    status_idle: "空闲",
    ...
    status_joined: "已加入",
    status_paused: "已暂停",
    status_completed: "已压缩",
    status_failed: "压缩失败",
    status_cancelled: "已取消",
    panel_title: "压缩",
    in_progress_note: "正在按有界批次处理——可继续聊天。",
    view_history: "查看更早的消息",
    completed_detail: "更早的消息仍可搜索。当前视图保留最近轮次和有界概览。",
    failed_detail: "压缩因错误停止。对话完好——可稍后重试。",
    cancelled_detail: "压缩已取消。已保存的分段将用于下次运行。",
    joined_detail: "已加入此对话正在运行的压缩任务。",
    running_detail: "正在按有界分段压缩更早的历史。",
