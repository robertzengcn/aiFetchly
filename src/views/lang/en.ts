...
export default {
  ...
  route: {
    ...
    social_account: "Tool Account",
    account_list: "Tool Account List",
    edit_account: "Edit Tool Account",
    add_account: "Add Tool Account",
    tool_account: "Tool Account",
    tool_account_list: "Tool Account List",
    edit_tool_account: "Edit Tool Account",
    add_tool_account: "Add Tool Account",
    schedule: "Schedule",
    ...
    yellow_pages_list: "Directory Assistant",
    ...
    email_send_log_detail: "Email Send Log Detail",
    ...
    email_filter_list: "Email Filter List",
  ...
  knowledge: {
    ...
    duplicate_detected: "Duplicate Files Detected",
    duplicate_files_found: "The following files already exist in your library:",
  ...
  home: {
    ...
    yellowpage: "Directory Assistant",
    ...
    keywords_placeholder:
      "Enter keywords separated by commas (e.g., restaurant, pizza, italian)",
    ...
    headless_mode_hint:
      "When enabled, browser runs without visible UI (faster, less resource usage)",
    ...
    account_required_when_enabled:
      "Account selection is required when using account - please select at least one account",
    proxy_required_when_enabled:
      "Proxy selection is required when using proxy - please select at least one proxy",
    scheduled_time_required:
      "Scheduled time is required for one-time scheduling - please select a date and time",
    cron_expression_required:
      "Cron expression is required for recurring scheduling - please enter a valid cron expression",
    ...
    delay_range_error:
      "Delay between requests must be between 0 and 10000 milliseconds",
    platform_inactive_error:
      'Platform "{platformName}" is currently inactive - please select an active platform',
    ...
    emailmarketing: "Outreach Campaign",
  ...
  search: {
    ...
    google_account_cookies_required:
      "A Google account with cookies is required for Google search. Please add a Google account with valid cookies in Tool Accounts.",
    task_id: "Task ID",
    run_task: "Run Task",
  ...
  proxy: {
    ...
    no_proxy_to_import:
      "The available proxy number is less than one, no proxy to import",
    ...
    download_template_hint:
      'Click the "Download Template" button to get the CSV template file',
    edit_template: "Edit Template",
    edit_template_hint:
      "Open the downloaded CSV file and add your proxy information (host, port, protocol, username, password)",
    protocol_hint: "The protocol can be http, https, socks5",
    upload_file: "Upload File",
    upload_file_hint: "Select your edited CSV file using the file input below",
    check_proxies: "Check Proxies",
    check_proxies_hint: 'Use "Check Proxy" to validate the uploaded proxies',
    how_to_batch_upload: "How to Batch Upload Proxies",
    // New batch upload dialog translations
    batch_upload: "Batch Upload",
    paste_text: "Paste Text",
    paste_proxy_hint: "Paste proxies (one per line)",
    format_hint:
      "Formats: host:port, host:port:user:pass, protocol://host:port:user:pass",
    parsed_proxies: "Parsed Proxies",
    proxies_parsed: "proxies parsed",
    import_rows_missing_fields:
      "{count} row(s) skipped: each proxy must include host, port, and protocol (file row numbers: {rows}).",
    import_partial_rows_missing_fields:
      "{valid} proxy/proxies loaded; {count} row(s) skipped — missing host, port, or protocol (file row numbers: {rows}).",
    no_valid_proxies: "No valid proxies found",
    enter_proxy_text: "Please enter proxy text",
    parse_text: "Parse Text",
    no_proxies_to_check: "No proxies to check",
    check_complete: "Check complete",
    no_proxies_to_import: "No proxies to import",
    import_success: "proxies imported successfully",
    import_partial: "Some proxies failed to import",
  ...
  aiTemplateGeneration: {
    ...
    invalidVariables:
      "Template contained unsupported variables and they were removed:",
  ...
  emailReceive: {
    ...
    select_email_service: "Email Service",
    select_email_service_hint:
      "Please select an Email Service to view messages.",
    sync: "Sync",
    ...
    unread_unavailable_pop3:
      "Unread status is not available for POP3 mailboxes.",
  ...
  socialaccount: {
    ...
    delete_tool_account_confirm_title: "Confirm to delete tool account",
    delete_tool_account_confirm_text: "The tool account will be deleted",
  ...
  system_settings: {
    ...
    manage_ai_provider: "AI Provider",
    manage_hooks: "Manage Hooks",
    manage_subagents: "Manage Subagents",
    hooks: {
      ...
      trust_confirm_body:
        'Trusting means the local process "{command}" will run on every matching "{event}" event.',
      ...
      untrusted_warning:
        "This hook is not trusted and will not run. Click Trust to allow it to execute.",
      scraping_compliance_warning:
        "Enabling this hook injects compliance context into the AI prompt after every scrape tool call, which may affect scrape results.",
    },
  ...
  aiMemory: {
    title: "AI Memories",
    description:
      "Durable facts and preferences the AI remembers across conversations.",
    ...
    empty_description:
      "Create a memory so the AI remembers it across conversations.",
    ...
    confirm_archive_text:
      "Archived memories are hidden from the AI. You can restore them later by editing.",
  ...
  skills: {
    ...
    no_skill_installed: "No skills installed",
    no_skill_description: "Import skill packages to extend AI capability",
    import_button: "Import Skill",
    import_dialog_title: "Import Skill from Zip",
    import_success: "Skill imported successfully",
    import_error: "Failed to import skill",
    uninstall_confirm: "Are you sure you want to uninstall this skill?",
    uninstall_success: "Skill uninstalled",
    uninstall_error: "Failed to uninstall skill",
    toggle_enable: "Enable",
    toggle_disable: "Disable",
    toggle_success: "Skill updated",
    toggle_error: "Failed to update skill",
    built_in: "Built-in",
  ...
  schedule: {
    ...
    ai_message_task_message_hint:
      "The prompt to send to the AI server on each scheduled run",
    ...
    ai_message_task_auto_approve_hint:
      "Allow the AI to execute selected tools without manual confirmation",
    ai_message_task_auto_approve_warning:
      "Warning: Auto-approve allows unattended tool execution. Only select tools you trust.",
  ...
  yellowPages: {
    ...
    ai_query_keywords: "AI query keywords",
    ai_query_keywords_default_seed: "business",
    use_account: "Use account",
    account_required_for_platform: "Account required for platform: {name}",
    not_set: "Not set",
    enabled: "Enabled",
    disabled: "Disabled",
    authentication: "Authentication",
    requires_cookies: "Requires Cookies",
    account_required_for_auth: "Account required for authentication",
    requires_login: "Requires Login",
    requires_api_key: "Requires API Key",
    requires_oauth: "Requires OAuth",
    location_required: "Location Required",
    platform_requires_location: "This platform requires a location for search",
    // List / manage page
    list_manual_refresh: "Manual refresh",
    list_auto_refresh_enabled: "Auto-refresh enabled (5s)",
    list_auto_refresh_paused: "Auto-refresh paused (page not visible)",
    list_auto_refresh_disabled: "Auto-refresh disabled",
    list_auto_refresh_on: "Auto-refresh ON",
    list_auto_refresh_paused_btn: "Auto-refresh PAUSED",
    list_auto_refresh_off: "Auto-refresh OFF",
    list_last_updated: "Last updated",
    list_auto_refresh_interval: "Auto-refresh: {seconds}s",
    list_search_placeholder: "Search by task name or platform...",
    list_filter_search: "Search",
    list_filter_status: "Status",
    list_filter_platform: "Platform",
    list_filter_priority: "Priority",
    list_tasks_match_filters:
      "{total} of {totalUnfiltered} tasks match filters",
    list_no_tasks_match_filters: "No tasks match your filters",
    list_adjust_search_or_clear:
      "Try adjusting your search criteria or clearing some filters",
    list_clear_all_filters: "Clear All Filters",
    list_applying_filters: "Applying filters...",
    list_task_not_running: 'Task "{name}" is not currently running',
    list_confirm_stop_task:
      'Are you sure you want to stop task "{name}" (PID: {pid})?\n\nThis will terminate the running process and update the task status.',
    list_task_stopped_success:
      'Successfully stopped task "{name}"!\n\nTask status has been updated to "Pending" and the table will refresh to show the changes.',
    list_task_stop_failed: 'Failed to stop task "{name}": {message}',
    list_error_stopping_task: 'Error stopping task "{name}": {message}',
    list_task_pause_failed: 'Failed to pause task "{name}": {message}',
    list_task_resumed_success: 'Task "{name}" resumed successfully',
    list_task_resume_failed: 'Failed to resume task "{name}": {message}',
    list_task_still_running_results:
      "Task is still running. Results will be available when data alignment completes.",
    list_task_no_results_yet: "This task has no results yet.",
    list_view_results_anyway_confirm:
      "Do you still want to view the results page?",
    list_unknown_error: "Unknown error",
    list_unknown_error_occurred: "Unknown error occurred",
    // Task details view
    detail_task_information: "Task Information",
    detail_task_status: "Task Status",
    detail_task_actions: "Task Actions",
    detail_field_name: "Name",
    detail_field_platform: "Platform",
    detail_field_keywords: "Keywords",
    detail_field_location: "Location",
    detail_field_max_pages: "Max Pages",
    detail_field_priority: "Priority",
    detail_field_status: "Status",
    detail_field_progress: "Progress",
    detail_field_results_count: "Results Count",
    detail_field_created: "Created",
    detail_field_last_updated: "Last Updated",
    detail_action_start: "Start Task",
    detail_action_stop: "Stop Task",
    detail_action_pause: "Pause Task",
    detail_action_resume: "Resume Task",
    detail_action_view_results: "View Results",
    detail_action_edit: "Edit Task",
    detail_action_delete: "Delete Task",
    detail_action_close: "Close",
    detail_status_pending: "Pending",
    detail_status_running: "Running",
    detail_status_completed: "Completed",
    detail_status_failed: "Failed",
    detail_status_paused: "Paused",
  },
  googleMaps: {
    ...
    status_loading: "Loading Channel Alpha...",
  ...
  yandexMaps: {
    ...
    query_hint: "Enter a business type or name to search for",
    location_label: "Location",
    location_placeholder: "e.g. Moscow, Saint Petersburg, Russia",
    location_hint: "Enter a city or region to search in",
    max_results_label: "Maximum Results",
    include_website: "Include Website",
    include_reviews: "Include Reviews",
    show_browser: "Show Browser (Debug)",
    language_label: "Language",
    language_placeholder: "e.g. ru, en, tr",
    language_hint: "Channel Beta interface language code",
    region_label: "Region",
    region_placeholder: "e.g. ru, kz, by",
    region_hint: "Region code for search context",
    start_search: "Start Search",
    cancel_search: "Cancel",
    searching: "Searching...",
    progress_label: "{current} / {total} businesses",
    found_results: "Found {count} businesses for '{query}' in '{location}'",
    copy_all: "Copy All",
    export_csv: "Export To Routing Sheet",
    export_json: "Export JSON",
    ...
    status_validating: "Validating input...",
    status_launching: "Launching browser...",
    status_loading: "Loading Channel Beta...",
    status_extracting: "Aligning business information ({current}/{total})...",
    status_completed: "Search completed",
    status_cancelled: "Search cancelled",
    status_failed: "Search failed",
  ...
  mapScraper: {
    ...
    query_hint: "Enter a business type or name to search for",
    location_label: "Location",
    location_placeholder_google: "e.g. New York, London, 90210",
    location_placeholder_yandex: "e.g. Moscow, Saint Petersburg, Russia",
    location_hint_google: "Enter a city, address, or zip code",
    location_hint_yandex: "Enter a city or region to search in",
    max_results_label: "Maximum Results",
    include_website: "Include Website",
    include_reviews: "Include Reviews",
    show_browser: "Show Browser (Debug)",
    ...
    progress_label: "{current} / {total} businesses",
    found_results:
      "Found {count} {provider} businesses for '{query}' in '{location}'",
    copy_all: "Copy All",
    export_csv: "Export To Routing Sheet",
    export_json: "Export JSON",
    reviews_count: "{count} reviews",
    ...
    proxy_hint: "Rotate through selected proxies per card",
    proxy_placeholder: "Select proxies...",
    history_title: "{provider} History",
    history_empty: "No search history yet",
    view_results: "View",
    delete_btn: "Delete",
  },
  ...
  aiProvider: {
    ...
    mode_hosted: "Hosted aiFetchly",
    mode_local: "Custom / Local Provider",
    hosted_enabled: "Hosted aiFetchly AI is enabled for your account.",
    ...
    context_size: "Context size (optional)",
    ...
    cap_label_tools: "Tools",
    cap_label_vision: "Vision",
    cap_label_context: "Context",
    cap_supported: "Supported",
    cap_unsupported: "Unsupported",
    cap_unknown: "Unknown",
    cap_failed: "Failed",
    indicator_hosted: "Hosted",
    indicator_local: "Local",
    indicator_offline: "Local offline",
    indicator_unavailable: "Model unavailable",
    tool_warning:
      "This local provider has not confirmed tool support. Tools are disabled for this conversation.",
  },
  aiArtifacts: {
  ...
  aiChatV2: {
    ...
    goalLoop: {
      ...
      noActiveGoal: "Set a goal first with /goal <objective>.",
      startFailed: "Could not start the loop.",
      stop: "Stop loop",
    ...
    voice: {
      ...
      install_model: "Install voice model",
      ...
      model_name_whisper_tiny: "Whisper Tiny (Fast STT)",
      model_name_whisper_base: "Whisper Base (Recommended STT)",
      model_name_whisper_small: "Whisper Small (High Accuracy STT)",
      model_name_piper_amy: "Piper VITS en_US Amy (TTS)",
      model_type_stt: "Speech Recognition",
      model_type_tts: "Text-to-Speech",
      installed: "Installed",
      download: "Download",
    ...
    recovery: {
      ...
      stop_hint: "Press Stop to cancel",
      api_retry: "Reconnecting to AI server…",
      overload_retry: "AI server overloaded, retrying…",
      output_token_recovery: "Recovering truncated response…",
      reactive_compact: "Summarizing conversation to fit context…",
      context_collapse_drain: "Trimming older context…",
      model_fallback: "Switching to a backup model…",
      persistent_retry: "Retrying in the background…",
    },
    cancelled: "Cancelled",
  ...
  aifetchlyConfig: {
    ...
    workspaceTrustBody:
      "This workspace defines AiFetchly configuration. Review and trust it before enabling commands.",
  ...
  agentTaskList: {
    ...
    no_tasks: "No agent tasks yet",
    refresh: "Refresh",
    cancel: "Cancel",
    just_now: "just now",
    status_queued: "Queued",
    status_running: "Running",
    status_waiting_policy: "Waiting Policy",
  ...
  aiChatV2Plan: {
    ...
    status_draft: "Draft",
    status_awaiting_question: "Awaiting Answer",
  ...
  subagents: {
    ...
    status_warning: "Has warnings",
    plugin_empty: "This plugin does not include subagents.",
    delete_confirm: "Delete this subagent?",
    readonly_plugin_hint:
      "Plugin subagents are read-only. Disable them or edit the plugin source.",
    readonly_workspace_hint:
      "Workspace subagents are read-only. Edit the workspace agent file to change them.",
    ...
    field_component_path: "Component path",
    field_mode: "Mode",
  ...
  plugins: {
    ...
    source_path_unknown: "Unknown",
    source_path_imported_from: "Imported from",
    source_path_installed_at: "Installed at",
    status_healthy: "Healthy",
    status_disabled: "Disabled",
    status_needs_configuration: "Needs Configuration",
    status_partial_load: "Partial Load",
    ...
    uninstall_confirm:
      "Uninstall this plugin? This removes its skills and MCP servers.",
    uninstall_button: "Uninstall",
    import_validation_failed: "Package validation failed",
    import_success: "Plugin imported successfully",
    import_failed: "Plugin import failed",
    empty_state:
      "No plugins installed. Click Import Plugin to install one from a zip file.",
    select_zip: "Select a plugin .zip file",
    ...
    no_hooks: "No hooks in this plugin.",
    ...
    marketplace: {
      ...
      source_label:
        "Marketplace source (owner/repo, git URL, folder, or marketplace.json URL)",
      source_hint:
        "Examples: owner/repo, https://github.com/owner/repo.git, /local/folder, https://host/marketplace.json",
      ...
      confirm_remove:
        "Remove this marketplace? Installed plugins from it will remain installed.",
  ...
  localAiRuntime: {
    title: "Local AI Components",
    embedding_title: "Local Embedding (on-device)",
    voice_title: "Local Voice (on-device)",
    ...
    cancel: "Cancel",
    retry: "Retry",
    remove_models: "Also remove downloaded models",
    install_confirm: "Install this component? It will be downloaded on demand.",
    remove_confirm:
      "Remove this component? The feature will become unavailable.",
    errors: {
      catalog_unavailable:
      ...
      health_check_failed: "Component health check failed.",
      busy: "Another operation is in progress.",
      remove_failed: "Removal failed. Try again after restarting.",
    },
  },
  portableMemory: {
    ...
    rescan: "Rescan",
    enableTitle: "Enable portable memory",
    ...
    policyReviewAll: "Review everything",
    exportExisting: "Export existing memories",
    exportNone: "Do not export",
    ...
    bridgeAction: {
      ...
      insert: "will be added",
      replace: "will be updated",
      "no-op": "already installed",
      blocked: "blocked — resolve manually",
    },
    storageMode: "Storage mode",
    storagePrivate: "Private (SQLite only)",
    ...
    reviewTitle: "Review external changes",
    loadingReview: "Loading pending changes…",
    noPending: "No pending changes.",
    reviewNew: "New records",
    reviewEdits: "Edits to known records",
    reviewDeletions: "Deleted files",
    approve: "Approve",
    reject: "Reject",
    approveDeletion: "Confirm deletion",
    rejectDeletion: "Keep record",
    review: "Review",
    settings: "Settings",
    revealFile: "Reveal file",
    diagnosticsTitle: "Portable memory diagnostics",
    loadingDiagnostics: "Loading diagnostics…",
    noDiagnostics: "No diagnostics. All portable memory files are valid.",
    ...
    status: "Status",
    confidence: "Confidence",
    actionUseFile: "Use file version",
    actionUseAiFetchly: "Use AiFetchly version",
    actionMerge: "Merge manually",
    resolve: "Resolve",
    typeProject: "Project",
  ...
  workspaceMemory: {
    ...
    emptyHint: "Memories saved here apply only to this workspace.",
    create: "Create memory",
    edit: "Edit memory",
    archive: "Archive",
    delete: "Delete",
    deleteConfirm: "Delete this workspace memory permanently?",
    deleteSuccess: "Workspace memory deleted.",
    search: "Search",
    searchPlaceholder: "Search workspace memory...",
    typeProject: "Project",
    typeDecision: "Decision",
    typeWorkflow: "Workflow",
    typeConvention: "Convention",
    ...
    save: "Save",
    cancel: "Cancel",
    createError: "Failed to save workspace memory.",
    typeField: "Type",
    titleField: "Title",
    contentField: "Content",
    statusField: "Status",
    loadError: "Failed to load workspace memory.",
  },
  diagnostics: {
    title: "Diagnostics",
  ...
  about: {
    ...
    restart_to_install: "Restart to Update",
    status_idle: "Click to check for the latest version.",
    status_checking: "Checking for updates…",
    status_up_to_date: "You're on the latest version ({version}).",
    status_downloading: "Downloading update…",
    status_ready_to_restart: "Update downloaded. Restart to apply.",
    status_error: "Could not check for updates. Try again later.",
  ...
  workspaceChat: {
    ...
    status: {
      running: "Running",
      queued: "Queued",
      awaitingPermission: "Permission required",
      awaitingUser: "Your input is required",
      failed: "Failed",
    ...
    runStrip: {
      goal: "Goal: {objective}",
      loopRunning: "Scheduled loop running",
      loopPaused: "Scheduled loop paused",
      stop: "Stop",
      details: "Details",
      running: "Working…",
      queued: "Queued",
      permission: "Waiting for approval",
      userInput: "Waiting for your answer",
      failed: "Failed",
      recovering: "Recovering",
      interrupted: "Interrupted",
    },
    ...
    activity: {
      ...
      execution: "Execution",
      runs: "Runs",
      selectConversation: "Select a conversation to see its runs.",
    ...
    context: {
      selectConversation: "Select a conversation to see its context.",
      workspace: "Workspace",
      noWorkspace: "No workspace is bound to this chat.",
      usage: "Context usage",
      used: "Used",
      tokens: "tokens",
      attachmentsSection: "Attached context",
      noAttachments: "No attachments or mentions in this conversation yet.",
      atMention: "Mentioned file",
      compact: "Compact conversation",
      trusted: "Trusted",
      revoked: "Revoked",
    },
    ...
    plan: {
      ...
      discardConfirm: "Discard this plan? This cannot be undone.",
      ...
      receiptCompleted: "Plan completed",
      receiptRejected: "Plan discarded",
      receiptCancelled: "Plan cancelled",
      receiptChangesRequested: "Changes requested",
      status: {
        draft: "Drafting",
        awaiting_question: "Clarifying",
  ...
  managedBrowser: {
    ...
    approval: {
      ...
      body: "The assistant wants to perform a consequential action in the managed browser:",
      allow: "Allow once",
      deny: "Deny",
    },
    notices: {
      login_required: "Login needed — the browser window is waiting for you",
      login_verifying: "Verifying your login…",
      login_verified: "Login verified — session saved",
      login_verification_failed: "Login could not be verified yet",
      session_persistence_failed: "Could not save the refreshed login session",
      challenge_detected: "Verification challenge detected — your turn",
    ...
    states: {
      starting: "Starting",
      validating_fingerprint: "Checking browser",
      applying_session: "Applying login session",
      verifying_login: "Verifying login",
      login_required: "Login required",
      user_login_in_progress: "Waiting for your login",
      verifying_manual_login: "Verifying your login",
      ready: "Ready",
      running: "Working",
      awaiting_approval: "Awaiting approval",
      challenge_detected: "Verification challenge",
      challenge_resolving: "Resolving challenge",
    ...
    errors: {
      ai_disabled: "AI features are not enabled",
      managed_browser_disabled: "Managed browser is disabled",
      account_in_use: "This account is already in use",
      global_session_limit: "Session limit reached",
      browser_dependency_missing: "Browser is not installed or unavailable",
      worker_exited: "Browser process ended unexpectedly",
      worker_start_timeout: "Browser took too long to start",
      challenge_requires_handoff: "This page needs your confirmation",
      action_not_allowed: "This action is not allowed right now",
      cache_clear_deferred: "Cache clear is waiting for the session to end",
    ...
    handoff: {
      ...
      reasons: {
        ...
        login_expired: "The saved login session has expired.",
        captcha_sensitive_flow: "This step needs a human confirmation.",
        mfa_prompt: "The site asked for multi-factor authentication.",
        passkey_prompt: "The site asked for a passkey.",
        password_field: "A password field needs to be filled by you.",
        recovery_flow: "The account entered a recovery flow.",
        account_selection_ambiguous: "The account to use is unclear.",
    ...
    settings: {
      ...
      cache_phase_scanning: "Scanning cache…",
      cache_max_label: "Maximum cache size (MB)",
      clear_choice_stop: "Stop browser and clear now",
      clear_choice_defer: "Clear when this browser closes",
      cache_phase_deleting: "Deleting…",
      ...
      clear_preserves_logins:
        "Clearing the cache keeps your saved logins and account data.",
