...
export default {
  ...
  messages_title: "Received Messages",
   ...
   select_email_service_hint: "Please select an Email Service to view messages.",
  sync: "Sync",
...
emailAutoReplyAudit: {
  ...
  subagents: {
    ...
    readonly_workspace_hint: "Workspace subagents are read-only. Edit the workspace agent file to change them.",
