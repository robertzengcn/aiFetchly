...
export default {
  ...
  search: {
    ...
    enable_ai_recovery_hint:
      "When enabled, AI will help recover from scraping errors by analyzing page structure and suggesting alternative actions",
  },
  searchtask: {
    id: "Task Id",
  },
  ...
  contactExtraction: {
    ...
    status_pending: "Pending",
    select_items_hint:
      "Please select at least one item to extract contact info",
    no_valid_items_hint:
  ...
  yandexMaps: {
    ...
    description:
      "Search Yandex Maps for local businesses by keyword and location",
    query_label: "Business Keyword",
    query_placeholder: "e.g. dentist, Italian restaurant, plumber",
    query_hint: "Enter a business type or name to search for",
    location_label: "Location",
    ...
    language_hint: "Yandex Maps UI language code",
    region_label: "Region",
  ...
  mapScraper: {
    title: "Map Scraper",
    description: "Search local businesses across Google Maps and Yandex Maps",
    ...
    col_actions: "Actions",
    error_search_failed: "Search failed: {error}",
    view_on_maps: "View on {provider}",
    google_account_label: "Google Account",
    yandex_account_label: "Yandex Account",
    account_hint: "Select an account to use its cookies",
    proxy_label: "Proxies",
    proxy_hint: "Rotate through selected proxies per card",
    proxy_placeholder: "Select proxies...",
