...
export default {
  ...
  skillInstall: {
    ...
    manager: {
      ...
      empty: "No installed skills yet. Ask the assistant to install one, or use /skill.",
      source: 'Source',
      mode: 'Install mode',
      ...
      uninstallHint: "The installed copy is removed. Linked sources are preserved. Stored credentials follow your choice below.",
    ...
    state: {
      ...
      awaiting_secret: "Credential needed",
      activating: "Activating",
      verifying: "Verifying",
      ready: "Ready",
      failed: "Failed",
