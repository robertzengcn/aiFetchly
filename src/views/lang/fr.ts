...
export default {
  ...
  messages_title: "Messages Reçus",
   ...
   select_email_service_hint: "Veuillez sélectionner un service de messagerie pour voir les messages.",
  sync: "Synchroniser",
...
emailAutoReplyAudit: {
  ...
  aiProvider: {
    ...
    description: "Les fournisseurs personnalisés peuvent alimenter AI Chat avec votre propre modèle. Les fonctionnalités d'IA hébergée aiFetchly nécessitent toujours un abonnement.",
    ...
    hosted_requires_subscription: "L'IA hébergée aiFetchly nécessite un abonnement.",
    ...
    saved_local: "Fournisseur d'IA local enregistré. AI Chat peut désormais utiliser votre modèle configuré.",
    ...
    tool_warning: "Ce fournisseur local n'a pas confirmé la prise en charge des outils. Les outils sont désactivés pour cette conversation.",
  },
  aiArtifacts: {
  ...
  subagents: {
    ...
    readonly_plugin_hint: "Les sous-agents de plugin sont en lecture seule. Désactivez-les ou modifiez la source du plugin.",
    readonly_workspace_hint: "Les sous-agents d'espace de travail sont en lecture seule. Modifiez le fichier d'agent de l'espace de travail pour les changer.",
    ...
    validation_output_schema_invalid: "Le schéma de sortie n'est pas un JSON valide.",
  },
  plugins: {
    title: "Plugins",
