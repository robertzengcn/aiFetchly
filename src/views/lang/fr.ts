...
export default {
  ...
  home: {
    ...
    configure_yellow_pages_task:
      "Configure and create a new Yellow Pages scraping task",
    ...
    task_created_message:
      "Your Yellow Pages scraping task has been created successfully!",
    task_updated_successfully: "Task Updated Successfully",
    task_updated_message:
      "Your Yellow Pages scraping task has been updated successfully!",
