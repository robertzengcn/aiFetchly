...
export default {
  ...
  route: {
    ...
    ai_chat_workspace: "Espace de chat IA",
    ...
    plugins: "Plugins",
    community_plugins: "Extensions de la communauté",
    managed_browser: "Navigateur géré",
  ...
  aiChatV2: {
    ...
    model_none_hint: "Aucun modèle utilisable n’est configuré.",
    model_open_settings: "Ouvrir les paramètres du fournisseur",
    model_auto: "Auto",
    ...
    generatedImageRefs: {
      ...
      moveUp: "Monter",
      moveDown: "Descendre",
      referenceTrayTitle: "Images de référence",
      limitReached: "Vous pouvez référencer jusqu'à 3 images par requête.",
      batchOffer:
      ...
      errors: {
        ...
        generated_image_not_owned:
          "Vous ne pouvez référencer que des images générées dans cette conversation.",
        generated_image_missing:
          "L'image d'origine n'est plus disponible. Régénérez-la ou choisissez une autre référence.",
        generated_image_outside_store:
          "La source de l'image est en dehors de la zone de stockage approuvée et ne peut pas être utilisée.",
        generated_image_symlink_rejected:
          "Ce fichier n'est pas une image stockée standard. Choisissez un autre élément généré.",
        generated_image_unsupported_type:
          "Type d'image non pris en charge. Choisissez une image PNG, JPEG ou WebP.",
        generated_image_too_large:
          "Cette image dépasse la limite de taille. Essayez moins d'images ou des images plus petites.",
        generated_image_dimension_limit:
          "Cette image dépasse la limite de dimensions. Redimensionnez-la ou régénérez-la en plus petit.",
        generated_image_reference_limit:
          "Trop d'images référencées pour une seule requête. Utilisez le traitement par lot pour des éditions indépendantes.",
        generated_image_ambiguous:
          "Plusieurs images peuvent correspondre à votre demande. Sélectionnez celle voulue.",
        generated_image_fusion_limit:
          "La combinaison d'images est limitée à 3 à la fois. Modifiez le reste séparément ou par lot.",
  ...
  aiChatV2Plan: {
    ...
    other_option_label: "Autre",
    other_option_description: "Saisissez votre propre réponse",
    custom_answer_placeholder: "Saisissez votre réponse...",
    approve: "Approuver",
    reject: "Rejeter",
  ...
  portableMemory: {
    ...
    rescan: "Rescanner",
    enableTitle: "Activer la mémoire portable",
    ...
    policyReviewAll: "Tout examiner",
    exportExisting: "Exporter les mémoires existantes",
    exportNone: "Ne pas exporter",
    ...
    bridgeAction: {
      create: "sera créé",
      insert: "sera ajouté",
      replace: "sera mis à jour",
      "no-op": "déjà installé",
      blocked: "bloqué — résolvez manuellement",
    },
    storageMode: "Mode de stockage",
    storagePrivate: "Privé (SQLite uniquement)",
    ...
    reviewTitle: "Examiner les changements externes",
    loadingReview: "Chargement des changements en attente…",
    noPending: "Aucun changement en attente.",
    reviewNew: "Nouveaux enregistrements",
    reviewEdits: "Modifications d'enregistrements connus",
    reviewDeletions: "Fichiers supprimés",
    approve: "Approuver",
    reject: "Rejeter",
    approveDeletion: "Confirmer la suppression",
    rejectDeletion: "Conserver l'enregistrement",
    review: "Examiner",
    settings: "Paramètres",
    ...
    status: "Statut",
    confidence: "Confiance",
    actionUseFile: "Utiliser la version du fichier",
    actionUseAiFetchly: "Utiliser la version AiFetchly",
    actionMerge: "Fusionner manuellement",
    resolve: "Résoudre",
    typeProject: "Projet",
  ...
  workspaceChat: {
    ...
    empty: {
      title: "Posez une question ou choisissez une conversation à gauche.",
    },
    search: {
      placeholder: "Rechercher des conversations",
    },
    sidebar: {
      region: "Espaces de discussion",
      loadError: "Échec du chargement des espaces de travail",
      empty: "Aucune conversation pour le moment",
      unassigned: "Autres discussions",
      workspace: "Espace de travail",
      needsAttentionCount: "{count} conversations nécessitent votre attention",
    },
    status: {
      running: "En cours",
      queued: "En file d'attente",
      awaitingPermission: "Autorisation requise",
      awaitingUser: "Votre réponse est requise",
      failed: "Échec",
      interrupted: "Interrompu",
      cancelled: "Annulé",
      completedUnread: "Terminé, non lu",
      completed: "Terminé",
    ...
    headerStatus: {
      ...
      needsYourInput: "Votre réponse est requise",
      recovering: "Récupération",
      failed: "Échec",
      running: "En cours",
      runningTools: "En cours · {count} outils",
      queued: "En file d'attente",
    },
    header: {
      overflow: "Menu de conversation",
      rename: "Renommer la discussion",
      renamePrompt: "Renommer la discussion",
    ...
    runStrip: {
      ...
      loopRunning: "Boucle planifiée en cours",
      loopPaused: "Boucle planifiée en pause",
      stop: "Arrêter",
      details: "Détails",
      running: "En cours…",
      queued: "En file d'attente",
      permission: "En attente d'approbation",
      userInput: "En attente de votre réponse",
      failed: "Échec",
      recovering: "Récupération",
      interrupted: "Interrompu",
    },
    ...
    activity: {
      ...
      scheduledLoop: "Boucle planifiée",
      pause: "Suspendre",
      resume: "Reprendre",
    ...
    execution: {
      ...
      structuredResult: "Résultat structuré — détails dans Activité",
    },
    plan: {
      version: "Version",
      current: "actuelle",
      changeReason: "Motif de la modification",
      clarificationAnswers: "Réponses de clarification",
      decisions: "Décisions",
      submitted: "Plan soumis",
      readyForReview: "Plan prêt à être examiné",
      steps: "{count} étapes",
      changedSince: "Modifié depuis la v{version}",
      reviewFullPlan: "Examiner le plan complet",
      requestChanges: "Demander des modifications",
      approve: "Approuver le plan",
      planningQuestions: "Questions de planification",
      questionProgress: "{current} sur {total}",
      multiSelect: "Sélectionnez une ou plusieurs options",
      singleSelect: "Sélectionnez une option",
      reviewAndSubmit: "Vérifier et envoyer",
      answerReview: "Vos réponses",
      changeFeedbackPrompt: "Que faut-il modifier dans ce plan ?",
      moreActions: "Plus d'actions",
      discardConfirm: "Rejeter ce plan ? Cette action est irréversible.",
      discard: "Rejeter le plan",
      ...
      receiptCompleted: "Plan terminé",
      receiptRejected: "Plan abandonné",
      receiptCancelled: "Plan annulé",
      receiptChangesRequested: "Modifications demandées",
      status: {
        draft: "Rédaction",
        awaiting_question: "Clarification",
  ...
  communityPlugins: {
    ...
    signIn: "Se connecter",
    empty: "Aucune extension disponible",
    error: "Impossible de contacter le Plugin Hub",
    retry: "Réessayer",
    installFuture: "Installable dans une prochaine version.",
  ...
  managedBrowser: {
    ...
    approval: {
      ...
      body: "L'assistant souhaite effectuer une action conséquente dans le navigateur géré :",
      allow: "Autoriser une fois",
      deny: "Refuser",
    },
    notices: {
      login_required: "Connexion requise — la fenêtre vous attend",
    ...
    states: {
      starting: "Démarrage",
      validating_fingerprint: "Vérification du navigateur",
      applying_session: "Application de la session",
      verifying_login: "Vérification de la connexion",
      login_required: "Connexion requise",
      user_login_in_progress: "En attente de votre connexion",
      verifying_manual_login: "Vérification de votre connexion",
      ready: "Prêt",
      running: "En cours",
      awaiting_approval: "En attente d'approbation",
      challenge_detected: "Défi de vérification",
      challenge_resolving: "Résolution du défi",
      handoff: "Vous avez le contrôle",
    ...
    errors: {
      ai_disabled: "Les fonctions IA ne sont pas activées",
      ...
      action_not_allowed: "Cette action n'est pas autorisée pour le moment",
      cache_clear_deferred: "Le vidage attend la fin de la session",
      internal_error: "Une erreur est survenue",
    },
    handoff: {
      title: "Passage du navigateur",
      account_line: "Vous contrôlez désormais la fenêtre du navigateur de :",
      time_remaining: "Temps restant pour cette fenêtre de connexion :",
      saved_login_hint:
        "Connectez-vous dans la fenêtre ouverte. Votre session enregistrée est conservée ; seul le vidage du cache affecte le cache.",
      verify_login: "Je me suis connecté",
      extend: "Prolonger (10 min)",
      cancel_task: "Annuler la tâche",
      reasons: {
        login_required: "Le site exige une connexion pour continuer.",
        login_expired: "La session enregistrée a expiré.",
        captcha_sensitive_flow: "Cette étape exige une confirmation humaine.",
        mfa_prompt: "Le site a demandé l'authentification à deux facteurs.",
        passkey_prompt: "Le site a demandé une clé d'accès.",
    ...
    settings: {
      ...
      cache_phase_scanning: "Analyse du cache…",
      cache_max_label: "Taille maximale du cache (Mo)",
      clear_choice_stop: "Arrêter le navigateur et vider maintenant",
      clear_choice_defer: "Vider à la fermeture du navigateur",
      cache_phase_deleting: "Suppression…",
