...
export default {
  ...
  messages_title: "Empfangene Nachrichten",
   ...
   select_email_service_hint: "Bitte wählen Sie einen E-Mail-Dienst aus, um Nachrichten anzuzeigen.",
...
emailAutoReplyAudit: {
  ...
  aiProvider: {
    title: "KI-Anbieter",
    description: "Benutzerdefinierte Anbieter können AI Chat mit Ihrem eigenen Modell betreiben. Gehostete aiFetchly-KI-Funktionen benötigen weiterhin ein Abonnement.",
    ...
    hosted_requires_subscription: "Gehostete aiFetchly-KI benötigt ein Abonnement.",
    ...
    saved_local: "Lokaler KI-Anbieter gespeichert. AI Chat kann nun Ihr konfiguriertes Modell verwenden.",
    ...
    tool_warning: "Dieser lokale Anbieter hat keine Werkzeugunterstützung bestätigt. Werkzeuge sind für diese Unterhaltung deaktiviert.",
  },
  aiArtifacts: {
  ...
  subagents: {
    ...
    readonly_plugin_hint: "Plugin-Unteragenten sind schreibgeschützt. Deaktivieren Sie sie oder bearbeiten Sie die Plugin-Quelle.",
    readonly_workspace_hint: "Arbeitsbereich-Unteragenten sind schreibgeschützt. Bearbeiten Sie die Agentendatei im Arbeitsbereich, um sie zu ändern.",
