...
export default {
  ...
  route: {
    ...
    social_account: "Werkzeugkonto",
    account_list: "Werkzeugkontenliste",
    edit_account: "Werkzeugkonto bearbeiten",
    add_account: "Werkzeugkonto hinzufügen",
    tool_account: "Werkzeugkonto",
    tool_account_list: "Werkzeugkontenliste",
    edit_tool_account: "Werkzeugkonto bearbeiten",
    add_tool_account: "Werkzeugkonto hinzufügen",
    schedule: "Zeitplan",
    ...
    email_extraction: "Kontaktprofil-Einblicke",
    email_extraction_form: "Kontaktprofil-Einblicke",
    email_extraction_edit: "Kontaktprofil-Aufgabe bearbeiten",
    email_extraction_list: "Kontaktprofil-Aufgabenliste",
    email_extraction_detail: "Kontaktprofil-Details",
    yellow_pages: "Verzeichnis-Assistent",
    yellow_pages_list: "Verzeichnis-Assistent",
    create_yellow_pages_task: "Verzeichnis-Assistent-Aufgabe erstellen",
    edit_yellow_pages_task: "Verzeichnis-Assistent-Aufgabe bearbeiten",
    yellow_pages_task_detail: "Aufgabendetails",
    yellow_pages_results: "Aufgabenergebnisse",
    yandex_maps_scraper: "Lokale Unternehmen finden",
    ...
    email_filter_list: "E-Mail-Filter-Liste",
    ...
    ai_chat_workspace: "KI-Chat-Arbeitsbereich",
    ...
    managed_browser: "Verwalteter Browser",
  ...
  home: {
    ...
    search: "Markteinblicke",
    search_scraper: "Markteinblicke-Explorer",
    search_description: "Öffentliche Markteinblicksdaten werden strukturiert",
    yellowpage: "Gelbe Seiten",
    yellowpage_scraper: "Verzeichnis-Assistent",
    yellowpage_description: "Öffentliche Verzeichnisdaten werden abgeglichen",
    create_yellow_pages_task: "Verzeichnis-Assistent-Aufgabe erstellen",
    edit_yellow_pages_task: "Verzeichnis-Assistent-Aufgabe bearbeiten",
    configure_yellow_pages_task:
      "Neue Verzeichnis-Assistent-Aufgabe konfigurieren und erstellen",
    modify_yellow_pages_task: "Bestehende Verzeichnis-Assistent-Aufgabe ändern",
    ...
    task_created_message:
      "Ihre Verzeichnis-Assistent-Aufgabe wurde erfolgreich erstellt!",
    task_updated_successfully: "Aufgabe erfolgreich aktualisiert",
    task_updated_message:
      "Ihre Verzeichnis-Assistent-Aufgabe wurde erfolgreich aktualisiert!",
    ...
    emailextraction: "Kontaktprofil-Einblicke",
    emailextraction_subtitle: "Kontaktprofil-Einblicke",
    ...
    yellow_pages_task_management: "Verzeichnis-Assistent-Aufgabenverwaltung",
  ...
  search: {
    ...
    google_account_cookies_required:
      "Für die Google-Suche ist ein Google-Konto mit Cookies erforderlich. Bitte fügen Sie ein Google-Konto mit gültigen Cookies unter Werkzeugkonten hinzu.",
    task_id: "Aufgaben-ID",
    run_task: "Aufgabe ausführen",
  ...
  emailextraction: {
    ...
    edit_task: "Kontaktprofil-Aufgabe bearbeiten",
  ...
  emailscrape: {
    ...
    searchResult_empty: "No search results found for contact profile insights",
    mapsResult_empty:
      "Keine Website-URLs im ausgewählten Karten-Eintrag gefunden",
  ...
  emailReceive: {
    ...
    select_email_service: "E-Mail-Dienst",
    select_email_service_hint:
      "Bitte wählen Sie einen E-Mail-Dienst aus, um Nachrichten anzuzeigen.",
    ...
    unread_unavailable_pop3:
      "Der Ungelesen-Status ist für POP3-Postfächer nicht verfügbar.",
  ...
  socialaccount: {
    ...
    delete_account_errror: "Fehler beim Löschen des Werkzeugkontos",
    delete_tool_account_confirm_title: "Löschen des Werkzeugkontos bestätigen",
    delete_tool_account_confirm_text: "Das Werkzeugkonto wird gelöscht",
    login_account_error: "Fehler bei der Werkzeugkontoanmeldung",
    ...
    clear_cookies_confirm_title: "Löschen der Cookies bestätigen",
    clear_cookies_confirm_text:
      "Die Cookies für dieses Werkzeugkonto werden gelöscht",
    manuallogin_title: "Manuelle Anmeldung Hinweis",
    manuallogin_content:
      "Wir öffnen ein Popup-Fenster. Bitte melden Sie sich manuell bei der ausgewählten Plattform an und schließen Sie danach das Fenster. Das System speichert die Cookies des Werkzeugkontos automatisch",
    ...
    platform: "Plattform",
    name: "Name",
    name_hint: "Werkzeugkontonamen eingeben",
    phone: "Telefon",
    phone_hint: "Telefon des Werkzeugkontos eingeben",
    email: "E-Mail",
    email_hint: "E-Mail des Werkzeugkontos eingeben",
    select_proxy: "Proxy auswählen",
    change_proxy: "Proxy ändern",
    inactive: "Inaktiv",
    active: "Aktiv",
  ...
  system_settings: {
    ...
    hooks: {
      title: "Hooks-Verwaltung",
      description: "KI-Chat-Lebenszyklus-Hooks verwalten",
      global_enable: "Hooks global aktivieren",
      global_disable_banner:
        "Hooks sind global deaktiviert — kein Hook wird ausgeführt.",
      add_command: "+ Befehls-Hook hinzufügen",
      filter_event: "Ereignis",
      filter_source: "Quelle",
      filter_status: "Status",
      filter_hook: "Hook",
      last_rows: "Letzte Zeilen",
      show_session: "Sitzungs-Hooks anzeigen",
      list_empty: "Keine Hooks konfiguriert",
      create_first: "Erstellen Sie Ihren ersten Befehls-Hook",
      trust_required: "Vertrauen erforderlich",
      trust_confirm_title: "Diesem Befehls-Hook vertrauen?",
      trust_confirm_body:
        'Vertrauen bedeutet, dass der lokale Prozess "{command}" bei jedem übereinstimmenden "{event}"-Ereignis ausgeführt wird.',
      delete_confirm_title: "Diesen Hook löschen?",
      delete_confirm_body: "Diese Aktion kann nicht rückgängig gemacht werden.",
      builtin_cannot_modify: "Eingebaute Hooks können nicht geändert werden",
      audit_title: "Letztes Audit-Log",
      audit_empty: "Noch keine Hook-Aktivität erfasst",
      audit_time: "Zeit",
      ...
      field: {
        ...
        env_allowlist: "Env-Erlaubnisliste (JSON)",
        enabled: "Aktiviert",
        trusted: "Vertraut",
        source: "Quelle",
      },
      ...
      toast: {
        saved: "Hook gespeichert",
        deleted: "Hook gelöscht",
        trust_updated: "Vertrauen aktualisiert",
        load_failed: "Hooks konnten nicht geladen werden",
        create_failed: "Hook konnte nicht erstellt werden",
      },
      untrusted_warning:
        "Dieser Hook ist nicht vertrauenswürdig und wird nicht ausgeführt. Klicken Sie auf Vertrauen, um ihn zu erlauben.",
      scraping_compliance_warning:
        "Die Aktivierung dieses Hook fügt nach jedem Scrape-Tool-Aufruf Compliance-Kontext in den AI-Prompt ein, was die Scrape-Ergebnisse beeinflussen kann.",
    },
    ...
    user_ai_workspace_auto_dream: "Workspace-Auto-Zusammenfassung",
  ...
  schedule: {
    ...
    email_marketing: "Outreach-Kampagne",
    email_extract: "Kontaktprofil-Einblicke",
  ...
  yellowPages: {
    ...
    // Task details view
    detail_task_information: "Aufgabeninformationen",
    detail_task_status: "Aufgabenstatus",
    detail_task_actions: "Aufgabenaktionen",
    detail_field_name: "Name",
    detail_field_platform: "Plattform",
    detail_field_keywords: "Schlüsselwörter",
    detail_field_location: "Standort",
    detail_field_max_pages: "Max. Seiten",
    detail_field_priority: "Priorität",
    detail_field_status: "Status",
    detail_field_progress: "Fortschritt",
    detail_field_results_count: "Anzahl Ergebnisse",
    detail_field_created: "Erstellt",
    detail_field_last_updated: "Zuletzt aktualisiert",
    detail_action_start: "Aufgabe starten",
    detail_action_stop: "Aufgabe stoppen",
    detail_action_pause: "Aufgabe pausieren",
    detail_action_resume: "Fortsetzen",
    detail_action_view_results: "Ergebnisse anzeigen",
    detail_action_edit: "Aufgabe bearbeiten",
    detail_action_delete: "Aufgabe löschen",
    detail_action_close: "Schließen",
    detail_status_pending: "Ausstehend",
    detail_status_running: "Läuft",
    detail_status_completed: "Abgeschlossen",
    detail_status_failed: "Fehlgeschlagen",
    detail_status_paused: "Pausiert",
  },
  googleMaps: {
    title: "Lokale Unternehmen finden",
  ...
  agentWorkflow: {
    ...
    status_waiting_policy: "Wartet auf Richtlinie",
    status_waiting_user: "Wartet auf Benutzer",
    status_completed: "Abgeschlossen",
    status_failed: "Fehlgeschlagen",
    status_cancelled: "Abgebrochen",
    status_timeout: "Zeitüberschreitung",
    error_ai_disabled: "KI-Funktionen sind nicht aktiviert.",
    error_unknown_agent: "Unbekannter oder deaktivierter Agent.",
  ...
  aiProvider: {
    title: "KI-Anbieter",
    description:
      "Benutzerdefinierte Anbieter können AI Chat mit Ihrem eigenen Modell betreiben. Gehostete aiFetchly-KI-Funktionen benötigen weiterhin ein Abonnement.",
    mode_hosted: "Gehostet (aiFetchly)",
    mode_local: "Benutzerdefinierter / lokaler Anbieter",
    hosted_enabled: "Gehostete aiFetchly-KI ist für Ihr Konto aktiviert.",
    hosted_requires_subscription:
      "Gehostete aiFetchly-KI benötigt ein Abonnement.",
    preset: "Anbieter-Voreinstellung",
    name: "Anbietername",
    base_url: "Basis-URL",
    ...
    context_size: "Kontextgröße (optional)",
    refresh_models: "Modelle aktualisieren",
    test_connection: "Verbindung testen",
    save: "Speichern",
    models_loaded: "Modellliste geladen.",
    saved_local:
    ...
    cap_label_tools: "Werkzeuge",
    cap_label_vision: "Vision",
    cap_label_context: "Kontext",
    cap_supported: "Unterstützt",
    cap_unsupported: "Nicht unterstützt",
    cap_unknown: "Unbekannt",
    cap_failed: "Fehlgeschlagen",
    indicator_hosted: "Gehostet",
    indicator_local: "Lokal",
    indicator_offline: "Lokal offline",
    indicator_unavailable: "Modell nicht verfügbar",
    tool_warning:
      "Dieser lokale Anbieter hat keine Werkzeugunterstützung bestätigt. Werkzeuge sind für diese Unterhaltung deaktiviert.",
  },
  aiArtifacts: {
  ...
  outreach: {
    ...
    template_description:
      "Erstelle und verwalte E-Mail-Vorlagen für Outreach-Kampagnen.",
    filter_description:
      "Definiere Filter, um deine Outreach-Zielsegmente zu segmentieren und zu steuern.",
    service_description:
      "Konfiguriere SMTP- und IMAP-E-Mail-Dienstverbindungen.",
  ...
  aiChatV2: {
    ...
    atMentions: {
      ...
      tooManyMentions:
        "Zu viele Erwähnungen. Entfernen Sie einige Dateien und versuchen Sie es erneut.",
      fileNotFound: "Datei in diesem Arbeitsbereich nicht gefunden.",
      outsideWorkspace:
        "Erwähnung liegt außerhalb des genehmigten Arbeitsbereichs.",
      invalidLineRange: "Der Zeilenbereich muss vor dem Ende beginnen.",
    ...
    goalLoop: {
      ...
      countRequired: "Gib eine Iterationsanzahl an.",
      countRange: "Die Iterationsanzahl muss zwischen 1 und 10 liegen.",
      noActiveGoal: "Lege zuerst ein Ziel mit /goal <Ziel> fest.",
      startFailed: "Schleife konnte nicht gestartet werden.",
    ...
    voice: {
      ...
      speak_response: "Antwort vorlesen",
      stop_speaking: "Vorlesen stoppen",
      speaking: "Wiedergabe...",
      permission_denied: "Mikrofonberechtigung verweigert.",
      no_microphone: "Kein Mikrofon gefunden.",
      recording_failed: "Aufnahme fehlgeschlagen.",
      transcription_failed: "Sprachtranskription fehlgeschlagen.",
      tts_failed: "Sprachwiedergabe fehlgeschlagen.",
      model_missing: "Sprachmodell ist nicht installiert.",
      install_model: "Sprachmodell installieren",
      ...
      tts_language: "Sprache der Sprachausgabe",
      voice_model: "Sprachmodell",
      speech_speed: "Sprechgeschwindigkeit",
      stt_model: "Spracherkennungsmodell",
      tts_model: "Sprachantwortmodell",
      max_recording_duration: "Maximale Aufnahmedauer",
      open_settings: "Spracheinstellungen",
      voice_models: "Sprachmodelle",
      model_name_whisper_tiny: "Whisper Tiny (schnelle Spracherkennung)",
      model_name_whisper_base: "Whisper Base (empfohlene Spracherkennung)",
      model_name_whisper_small: "Whisper Small (hohe Genauigkeit)",
      model_name_piper_amy: "Piper VITS en_US Amy (Text-zu-Sprache)",
      model_type_stt: "Spracherkennung",
      model_type_tts: "Text-zu-Sprache",
      installed: "Installiert",
      download: "Herunterladen",
      cancel_download: "Abbrechen",
      downloading_pct: "Wird heruntergeladen... {pct}%",
    ...
    recovery: {
      ...
      stop_hint: "Stopp drücken zum Abbrechen",
      api_retry: "Verbindung zum AI-Server wird wiederhergestellt…",
      overload_retry: "AI-Server überlastet, erneut wird versucht…",
      output_token_recovery: "Abgebrochene Antwort wird wiederhergestellt…",
      reactive_compact: "Unterhaltung wird zusammengefasst…",
      context_collapse_drain: "Alter Kontext wird gekürzt…",
      model_fallback: "Wechsel zum Backup-Modell…",
      persistent_retry: "Erneuter Versuch im Hintergrund…",
    },
  ...
  aifetchlyConfig: {
    ...
    reloadStarted: "AiFetchly-Konfiguration wird neu geladen …",
    reloadResult:
      "AiFetchly-Konfiguration neu geladen:\n- Befehle: {commandCount}\n- Diagnosen: {diagnosticCount}",
    reloadFailed: "Neuladen der AiFetchly-Konfiguration fehlgeschlagen.",
    status: "Konfigurationsstatus",
    statusResult:
      "AiFetchly-Konfigurationsstatus:\n- Befehle: {commandCount}\n- Agents: {agentCount}\n- Hooks: {hookCount}\n- Skills: {skillCount}\n- Diagnosen: {diagnosticCount}\n- Letztes Neuladen: {lastReloadAt}\n- Watcher: {watcherState}",
    statusEmpty: "Keine globale Konfiguration geladen.",
    watcherNotStarted: "nicht gestartet (Phase 14)",
    diagnosticWarning: "Warnung",
    diagnosticError: "Fehler",
    diagnosticInfo: "Info",
    workspaceTrustTitle: "Workspace-AiFetchly-Konfiguration",
    workspaceTrustBody:
      "Dieser Workspace definiert eine AiFetchly-Konfiguration. Prüfen und genehmigen Sie diese, bevor Sie Befehle aktivieren.",
  ...
  slashCommands: {
    ...
    notDispatchable:
      "Geben Sie nach / einen Befehlsnamen ein, um ihn auszuführen.",
    notACommand: "Diese Nachricht ist kein Slash-Befehl.",
    disabledCommand: "Befehl /{name} ist deaktiviert.",
    sourceBuiltin: "Eingebaut",
    sourceUser: "Benutzer",
    sourceWorkspace: "Workspace",
    sourcePlugin: "Plugin",
    argumentHint: "Argumente",
    argumentHintNone: "keine",
  },
  agentTaskList: {
    ...
    status_running: "Ausführung",
    status_waiting_policy: "Warte auf Richtlinie",
    status_waiting_user: "Warte auf Benutzer",
    status_completed: "Abgeschlossen",
    status_failed: "Fehlgeschlagen",
    status_cancelled: "Abgebrochen",
    status_timeout: "Zeitüberschreitung",
  ...
  aiChatV2Plan: {
    ...
    status_awaiting_question: "Wartet auf Antwort",
    status_awaiting_approval: "Wartet auf Genehmigung",
  ...
  subagents: {
    ...
    add_button: "Unteragent hinzufügen",
    edit_title: "Unteragent bearbeiten",
    create_title: "Unteragent hinzufügen",
    empty_state: "Keine Unteragenten installiert.",
    no_filter_results: "Keine Unteragenten entsprechen diesen Filtern.",
    column_agent: "Agent",
    column_description: "Beschreibung",
    column_source: "Quelle",
    column_plugin: "Plugin",
    column_mode: "Modus",
    column_tools: "Werkzeuge",
    column_model: "Modell",
    column_status: "Status",
    column_health: "Zustand",
    column_actions: "Aktionen",
    source_builtin: "Eingebaut",
    source_plugin: "Plugin",
    source_workspace: "Arbeitsbereich",
    source_user: "Manuell",
    status_active: "Aktiviert",
    status_disabled: "Deaktiviert",
    status_warning: "Mit Warnungen",
    plugin_empty: "Dieses Plugin enthält keine Unteragenten.",
    delete_confirm: "Diesen Unteragenten löschen?",
    readonly_plugin_hint:
      "Plugin-Unteragenten sind schreibgeschützt. Deaktivieren Sie sie oder bearbeiten Sie die Plugin-Quelle.",
    readonly_workspace_hint:
      "Arbeitsbereich-Unteragenten sind schreibgeschützt. Bearbeiten Sie die Agentendatei im Arbeitsbereich, um sie zu ändern.",
    readonly_builtin_hint: "Eingebaute Unteragenten sind schreibgeschützt.",
    button_cancel: "Abbrechen",
    button_save: "Speichern",
    field_name: "Name",
    field_id: "ID",
    ...
    field_source_file: "Quelldatei",
    field_component_path: "Komponentenpfad",
    field_mode: "Modus",
    field_system_prompt: "System-Prompt",
    field_tools: "Erlaubte Werkzeuge",
    field_model: "Standardmodell",
    field_max_tool_calls: "Max. Werkzeugaufrufe",
    field_max_runtime_seconds: "Max. Laufzeit (Sekunden)",
    field_max_continue_calls: "Max. Fortsetzungsaufrufe",
    field_output_schema: "Ausgabe-Schema (JSON, optional)",
    field_warnings: "Warnungen",
    field_no_warnings: "Keine Warnungen",
    field_last_updated: "Zuletzt aktualisiert",
    field_created_at: "Erstellt",
    field_enabled: "Aktiviert",
    hint_id_locked: "ID ist nach Erstellung fest.",
    hint_tools_comma: "Durch Komma getrennte Werkzeugnamen.",
    hint_output_schema_json: "Nur gültiges JSON-Objekt.",
    validation_required: "Erforderlich.",
    validation_positive: "Muss eine positive Ganzzahl sein.",
    validation_output_schema_invalid: "Ausgabe-Schema ist kein gültiges JSON.",
  },
  plugins: {
    tabs: {
      discover: "Entdecken",
    ...
    column_version: "Version",
    column_source: "Quelle",
    column_source_path: "Importiert aus",
    column_sub_agent: "SubAgent",
    column_status: "Status",
    column_skills: "Skills",
    column_hooks: "Hooks",
    column_mcp_servers: "MCP-Server",
    column_permissions: "Berechtigungen",
    column_actions: "Aktionen",
    source_local: "Lokal",
    source_builtin: "Eingebaut",
    source_marketplace: "Marktplatz",
    source_path_unknown: "Unbekannt",
    source_path_imported_from: "Importiert aus",
    source_path_installed_at: "Installiert unter",
    status_healthy: "Gesund",
    status_disabled: "Deaktiviert",
    status_needs_configuration: "Konfiguration nötig",
    status_partial_load: "Teilweise geladen",
    status_invalid: "Ungültig",
    status_missing_files: "Dateien fehlen",
    tab_overview: "Übersicht",
    tab_skills: "Skills",
    tab_commands: "Befehle",
    tab_hooks: "Hooks",
    tab_mcp_servers: "MCP-Server",
    ...
    no_hooks: "Keine Hooks in diesem Plugin.",
    column_command: "Befehl",
    column_hook: "Hook",
    column_event: "Ereignis",
    column_matcher: "Matcher",
    column_type: "Typ",
    column_aliases: "Aliase",
    column_argument_hint: "Argumenthinweis",
    ...
    marketplace: {
      ...
      tab_marketplaces: "Marktplätze",
      tab_errors: "Fehler",
      add_button: "Marktplatz hinzufügen",
      add_title: "Plugin-Marktplatz hinzufügen",
      add_failed: "Marktplatz konnte nicht hinzugefügt werden.",
      source_label:
        "Marktplatz-Quelle (owner/repo, Git-URL, Ordner oder marketplace.json-URL)",
      source_hint:
        "Beispiele: owner/repo, https://github.com/owner/repo.git, /lokaler/ordner, https://host/marketplace.json",
      ref_label: "Branch / Tag / Commit (optional)",
      search_label: "Suchen",
      refresh_button: "Aktualisieren",
      refresh_all_button: "Alle aktualisieren",
      remove_button: "Entfernen",
      install_button: "Installieren",
      reinstall_button: "Neu installieren",
      view_details: "Details",
      confirm_remove:
        "Diesen Marktplatz entfernen? Installierte Plugins daraus bleiben installiert.",
      confirm_risk: "Ich verstehe die Risiken und möchte installieren.",
      column_marketplace: "Marktplatz",
      column_owner: "Besitzer",
      column_plugins: "Plugins",
      column_last_fetched: "Zuletzt abgerufen",
      health_label: "Status",
      errors_label: "Fehler",
      no_errors: "Keine Marktplatz-Fehler.",
      status_all: "Alle",
      ...
      health_fetch_failed: "Abruf fehlgeschlagen",
      health_missing_files: "Dateien fehlen",
      risk_mcp: "Startet MCP-Server",
      risk_hooks: "Deklariert Hooks",
      risk_monitors: "Deklariert Monitore",
      risk_npm: "Installiert von npm",
      risk_unpinned_git: "Nicht auf einen Commit fixiert",
    },
  },
  toolProgress: {
  ...
  workspaceMemory: {
    ...
    memoryAction: "Memory",
    noWorkspace: "Wähle einen Workspace, bevor du Workspace-Memory verwendest.",
    empty: "Noch keine Workspace-Memories.",
    emptyHint: "Hier gespeicherte Memories gelten nur für diesen Workspace.",
    create: "Memory erstellen",
    edit: "Memory bearbeiten",
    archive: "Archivieren",
    delete: "Löschen",
    deleteConfirm: "Diese Workspace-Memory dauerhaft löschen?",
    deleteSuccess: "Workspace-Memory gelöscht.",
    search: "Suchen",
    searchPlaceholder: "Workspace-Memory durchsuchen...",
    typeProject: "Projekt",
    typeDecision: "Entscheidung",
    typeWorkflow: "Workflow",
    typeConvention: "Konvention",
    ...
    statusActive: "Aktiv",
    statusArchived: "Archiviert",
    statusContradicted: "Widersprüchlich",
    showArchived: "Archivierte anzeigen",
    source: "Quelle",
    sourceManual: "Manuell",
    sourceChatV2: "Chat",
    sourceAgentTask: "Agenten-Aufgabe",
    ...
    manualMemoryEnabled: "Manuelles Workspace-Memory",
    runAutoSummary: "RUN AUTO SUMMARY",
    autoDreamRunning: "Workspace-Memory wird konsolidiert...",
    autoDreamFailed: "Der letzte Auto-dream-Lauf ist fehlgeschlagen.",
    autoDreamLastRun: "Letzter Lauf: {time}",
    save: "Speichern",
    cancel: "Abbrechen",
    createError: "Speichern der Workspace-Memory fehlgeschlagen.",
    typeField: "Typ",
    titleField: "Titel",
    contentField: "Inhalt",
    statusField: "Status",
    loadError: "Laden der Workspace-Memory fehlgeschlagen.",
  },
  diagnostics: {
    title: "Diagnose",
    storageUsage: "Belegter Speicher:",
    refresh: "Aktualisieren",
    enableDebug:
      "Debug-Protokollierung aktivieren (wird nach 24 Std. automatisch deaktiviert)",
    debugExpiresAt: "Debug-Protokollierung läuft ab am:",
    allowUpload: "Absturzberichte senden erlauben (nur manuelles Senden)",
    openFolder: "Diagnoseordner öffnen",
    exportReport: "Diagnosebericht exportieren",
    sendReport: "Absturzbericht senden",
    clearLocal: "Lokale Diagnosedaten löschen",
    clearConfirm:
      "Alle lokalen Diagnosedaten löschen? Vorgang kann nicht rückgängig gemacht werden.",
    selectCrash: "Absturz zum Senden auswählen",
  ...
  workspaceChat: {
    ...
    sidebar: {
      region: "Chat-Arbeitsbereiche",
      loadError: "Arbeitsbereiche konnten nicht geladen werden",
      empty: "Noch keine Unterhaltungen",
      unassigned: "Weitere Chats",
      workspace: "Arbeitsbereich",
      needsAttentionCount: "{count} Unterhaltungen erfordern Aufmerksamkeit",
    },
    status: {
      running: "Läuft",
      queued: "In Warteschlange",
      awaitingPermission: "Berechtigung erforderlich",
      awaitingUser: "Deine Eingabe ist erforderlich",
      failed: "Fehlgeschlagen",
      interrupted: "Unterbrochen",
      cancelled: "Abgebrochen",
      completedUnread: "Abgeschlossen, ungelesen",
      completed: "Abgeschlossen",
      needsAttention: "Erfordert Aufmerksamkeit",
      idle: "",
    },
    headerStatus: {
      needsPermission: "Berechtigung erforderlich",
      needsYourInput: "Deine Eingabe ist erforderlich",
      recovering: "Wird wiederhergestellt",
      failed: "Fehlgeschlagen",
      running: "Läuft",
      runningTools: "Läuft · {count} Werkzeuge",
      queued: "In Warteschlange",
    },
    header: {
      overflow: "Unterhaltungsmenü",
      rename: "Chat umbenennen",
      renamePrompt: "Chat umbenennen",
    ...
    runStrip: {
      goal: "Ziel: {objective}",
      loopRunning: "Geplante Schleife läuft",
      loopPaused: "Geplante Schleife pausiert",
      stop: "Stopp",
      details: "Details",
      running: "Läuft…",
      queued: "In Warteschlange",
      permission: "Wartet auf Genehmigung",
      userInput: "Wartet auf deine Antwort",
      failed: "Fehlgeschlagen",
      recovering: "Wird wiederhergestellt",
      interrupted: "Unterbrochen",
    },
    ...
    activity: {
      ...
      scheduledLoop: "Geplante Schleife",
      pause: "Pausieren",
      resume: "Fortsetzen",
    ...
    context: {
      selectConversation: "Wähle eine Unterhaltung, um ihren Kontext zu sehen.",
      workspace: "Arbeitsbereich",
      noWorkspace: "Dieser Chat ist mit keinem Arbeitsbereich verknüpft.",
      usage: "Kontextnutzung",
      used: "Genutzt",
      tokens: "Token",
    ...
    plan: {
      ...
      reviewFullPlan: "Vollständigen Plan ansehen",
      requestChanges: "Änderungen anfordern",
      approve: "Plan genehmigen",
      planningQuestions: "Planungsfragen",
      questionProgress: "{current} von {total}",
      multiSelect: "Eine oder mehrere auswählen",
      singleSelect: "Eine auswählen",
      ...
      receiptCompleted: "Plan abgeschlossen",
      receiptRejected: "Plan verworfen",
      receiptCancelled: "Plan abgebrochen",
      receiptChangesRequested: "Änderungen angefordert",
      status: {
        draft: "Entwurf",
        awaiting_question: "Klärung",
  ...
  managedBrowser: {
    ...
    approval: {
      ...
      body: "Der Assistent möchte eine folgenreiche Aktion im verwalteten Browser ausführen:",
      allow: "Einmal erlauben",
      deny: "Ablehnen",
    },
    notices: {
      login_required: "Anmeldung erforderlich — das Fenster wartet auf Sie",
    ...
    states: {
      ...
      validating_fingerprint: "Browser wird geprüft",
      applying_session: "Anmeldung wird angewendet",
      verifying_login: "Anmeldung wird geprüft",
      login_required: "Anmeldung erforderlich",
      user_login_in_progress: "Wartet auf Ihre Anmeldung",
      verifying_manual_login: "Ihre Anmeldung wird geprüft",
      ready: "Bereit",
      running: "Arbeitet",
      awaiting_approval: "Wartet auf Bestätigung",
      challenge_detected: "Verifizierungs-Herausforderung",
      challenge_resolving: "Herausforderung wird gelöst",
      handoff: "Sie haben die Kontrolle",
    ...
    errors: {
      ai_disabled: "KI-Funktionen sind nicht aktiviert",
      ...
      action_not_allowed: "Diese Aktion ist derzeit nicht erlaubt",
      cache_clear_deferred: "Das Leeren wartet auf das Sitzungsende",
      internal_error: "Etwas ist schiefgelaufen",
    },
    handoff: {
      title: "Browser-Übergabe",
      account_line: "Sie steuern jetzt das Browserfenster für:",
      time_remaining: "Verbleibende Zeit für dieses Anmeldefenster:",
      saved_login_hint:
        "Melden Sie sich im geöffneten Browserfenster an. Ihre gespeicherte Anmeldung bleibt erhalten — nur das Leeren betrifft den Cache.",
      verify_login: "Ich habe mich angemeldet",
      extend: "Zeit verlängern (10 Min.)",
    ...
    settings: {
      ...
      cache_phase_scanning: "Cache wird gescannt…",
      cache_max_label: "Maximale Cache-Größe (MB)",
      clear_choice_stop: "Browser stoppen und jetzt leeren",
      clear_choice_defer: "Leeren, wenn der Browser geschlossen wird",
      cache_phase_deleting: "Wird gelöscht…",
