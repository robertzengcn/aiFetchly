...
export default {
  ...
  plugins: {
    ...
    install_source: {
      ...
      working_archive: "Resolviendo la revisión y descargando el archivo…",
      working_clone: "Clonando el repositorio…",
      working_download: "Descargando el archivo…",
      working_fetch: "Obteniendo el paquete npm…",
      working_import: "Importando el plugin…",
  ...
  skillInstall: {
    ...
    manager: {
      ...
      empty: "Aún no hay habilidades instaladas. Pide al asistente que instale una, o usa /skill.",
      source: 'Origen',
      ...
      uninstallHint: "Se elimina la copia instalada. Los orígenes vinculados se conservan. Las credenciales siguen tu elección.",
