...
export default {
  ...
  route: {
    ...
    managed_browser: "Navegador gestionado",
  ...
  aiChatV2: {
    queue: {
      ...
      attachments_not_steerable:
        "Los mensajes con adjuntos se enviarán cuando termine la respuesta actual.",
      limit_reached:
        "Límite de cola alcanzado. Elimina un mensaje antes de volver a enviar.",
    ...
    voice: {
      ...
      input_disabled: "La entrada de voz está desactivada: abre los ajustes",
      permission_retry_hint: "Permite el acceso al micrófono e inténtalo de nuevo.",
    ...
    model_none_hint: "No hay ningún modelo utilizable configurado.",
    model_open_settings: "Abrir ajustes del proveedor",
  ...
  portableMemory: {
    ...
    enableTitle: "Activar memoria portátil",
    ...
    policyReviewAll: "Revisar todo",
    exportExisting: "Exportar memorias existentes",
    exportNone: "No exportar",
    ...
    bridgeAction: {
      create: "se creará",
      insert: "se añadirá",
      replace: "se actualizará",
      "no-op": "ya instalado",
      blocked: "bloqueado: resuélvelo manualmente",
    },
    storageMode: "Modo de almacenamiento",
    storagePrivate: "Privado (solo SQLite)",
    ...
    reviewTitle: "Revisar cambios externos",
    loadingReview: "Cargando cambios pendientes…",
    noPending: "Sin cambios pendientes.",
    reviewNew: "Registros nuevos",
    reviewEdits: "Ediciones a registros conocidos",
    reviewDeletions: "Archivos eliminados",
    approve: "Aprobar",
    reject: "Rechazar",
    approveDeletion: "Confirmar eliminación",
    rejectDeletion: "Conservar registro",
    review: "Revisar",
    settings: "Ajustes",
    ...
    mergeEditor: "Editor de fusión",
    title: "Título",
    content: "Contenido",
    type: "Tipo",
    status: "Estado",
    confidence: "Confianza",
    actionUseFile: "Usar versión del archivo",
    actionUseAiFetchly: "Usar versión de AiFetchly",
    actionMerge: "Fusionar manualmente",
    resolve: "Resolver",
    ...
    statusContradicted: "Contradicho",
  },
  ...
  workspaceChat: {
    ...
    sidebar: {
      region: "Espacios de chat",
      loadError: "No se pudieron cargar los espacios de trabajo",
      empty: "Aún no hay conversaciones",
      unassigned: "Otros chats",
      workspace: "Espacio de trabajo",
      needsAttentionCount: "{count} conversaciones requieren atención",
    },
    status: {
      running: "En ejecución",
      queued: "En cola",
      awaitingPermission: "Permiso requerido",
      awaitingUser: "Se requiere tu respuesta",
      failed: "Error",
      interrupted: "Interrumpido",
      cancelled: "Cancelado",
      completedUnread: "Completado, sin leer",
      completed: "Completado",
      needsAttention: "Requiere atención",
      idle: "",
    },
    headerStatus: {
      needsPermission: "Requiere permiso",
      needsYourInput: "Requiere tu respuesta",
      recovering: "Recuperando",
      failed: "Error",
      running: "En ejecución",
      runningTools: "En ejecución · {count} herramientas",
      queued: "En cola",
    },
    header: {
      overflow: "Menú de conversación",
      rename: "Renombrar chat",
      renamePrompt: "Renombrar chat",
    ...
    runStrip: {
      goal: "Objetivo: {objective}",
      loopRunning: "Bucle programado en ejecución",
      loopPaused: "Bucle programado en pausa",
      stop: "Detener",
      details: "Detalles",
      running: "Trabajando…",
      queued: "En cola",
      permission: "Esperando aprobación",
      userInput: "Esperando tu respuesta",
      failed: "Error",
      recovering: "Recuperando",
      interrupted: "Interrumpido",
    },
    ...
    activity: {
      ...
      scheduledLoop: "Bucle programado",
      pause: "Pausar",
      resume: "Reanudar",
    ...
    context: {
      selectConversation: "Selecciona una conversación para ver su contexto.",
      workspace: "Espacio de trabajo",
      noWorkspace: "Este chat no tiene un espacio de trabajo vinculado.",
      usage: "Uso del contexto",
      used: "Usado",
      tokens: "tokens",
      attachmentsSection: "Contexto adjunto",
      noAttachments: "Esta conversación aún no tiene adjuntos ni menciones.",
      atMention: "Archivo mencionado",
      compact: "Compactar conversación",
      trusted: "De confianza",
      revoked: "Revocado",
    },
    execution: {
      groupTitle: "Ejecución",
      progress: "{completed} de {total} completado",
    ...
    plan: {
      ...
      reviewFullPlan: "Revisar plan completo",
      requestChanges: "Solicitar cambios",
      approve: "Aprobar plan",
      planningQuestions: "Preguntas de planificación",
      questionProgress: "{current} de {total}",
      multiSelect: "Selecciona una o más",
      singleSelect: "Selecciona una",
      reviewAndSubmit: "Revisar y enviar",
      answerReview: "Tus respuestas",
      changeFeedbackPrompt: "¿Qué debería cambiar en este plan?",
      moreActions: "Más acciones",
      discardConfirm: "¿Descartar este plan? Esto no se puede deshacer.",
      discard: "Descartar plan",
      ...
      receiptCompleted: "Plan completado",
      receiptRejected: "Plan descartado",
      receiptCancelled: "Plan cancelado",
      receiptChangesRequested: "Cambios solicitados",
      status: {
        draft: "Redactando",
        awaiting_question: "Aclarando",
  ...
  managedBrowser: {
    ...
    start: {
      ...
      empty:
        "Aún no hay cuentas elegibles. Añade una cuenta con sesión guardada primero.",
      account_label: "Cuenta",
      purpose_placeholder: "¿Qué debe hacer el navegador?",
      start: "Iniciar navegador",
      confirm_title: "¿Iniciar el navegador gestionado?",
      confirm_body:
        "Se abrirá una ventana de Chrome visible para {account} con su sesión guardada.",
    },
    approval: {
      title: "La acción del navegador necesita aprobación",
      body: "El asistente quiere realizar una acción trascendente en el navegador gestionado:",
      allow: "Permitir una vez",
      deny: "Denegar",
    },
    notices: {
      login_required: "Se necesita inicio de sesión — la ventana te espera",
      login_verifying: "Verificando tu inicio de sesión…",
      login_verified: "Inicio de sesión verificado — sesión guardada",
      login_verification_failed:
        "No se pudo verificar el inicio de sesión todavía",
      session_persistence_failed: "No se pudo guardar la sesión renovada",
      challenge_detected: "Desafío de verificación detectado — te toca",
      challenge_provider_started:
        "Intentando resolver el desafío automáticamente…",
      challenge_resolved: "Desafío resuelto",
      challenge_failed: "El desafío no pudo resolverse automáticamente",
      challenge_manual_action_required:
        "El desafío requiere tu acción en la ventana",
      task_resuming: "Reanudando la tarea",
      browser_crashed: "La sesión del navegador terminó inesperadamente",
      cache_clear_deferred:
        "La limpieza de caché se ejecutará al terminar la sesión",
      cache_clear_completed: "Caché del navegador limpiada",
      cache_clear_failed: "Falló la limpieza de la caché",
      browser_state_blocked:
        "Se bloqueó de forma segura un aviso del navegador (diálogo, popup o descarga)",
    },
    states: {
      starting: "Iniciando",
      validating_fingerprint: "Comprobando navegador",
      applying_session: "Aplicando sesión de inicio",
      verifying_login: "Verificando inicio de sesión",
      login_required: "Inicio de sesión requerido",
      user_login_in_progress: "Esperando tu inicio de sesión",
      verifying_manual_login: "Verificando tu inicio de sesión",
      ready: "Listo",
      running: "Trabajando",
      awaiting_approval: "Esperando aprobación",
      challenge_detected: "Desafío de verificación",
      challenge_resolving: "Resolviendo desafío",
      handoff: "Tienes el control",
      stopping: "Deteniendo",
      stopped: "Detenido",
      failed: "Fallido",
    },
    ...
    errors: {
      ai_disabled: "Las funciones de IA no están habilitadas",
      managed_browser_disabled: "El navegador gestionado está desactivado",
      account_in_use: "Esta cuenta ya está en uso",
      global_session_limit: "Se alcanzó el límite de sesiones",
      browser_dependency_missing:
        "El navegador no está instalado o no está disponible",
      worker_exited: "El proceso del navegador terminó inesperadamente",
      worker_start_timeout: "El navegador tardó demasiado en iniciar",
      challenge_requires_handoff: "Esta página necesita tu confirmación",
      action_not_allowed: "Esta acción no está permitida ahora",
      cache_clear_deferred: "La limpieza espera a que termine la sesión",
      internal_error: "Algo salió mal",
    },
    handoff: {
      title: "Entrega del navegador",
      account_line: "Ahora controlas la ventana del navegador de:",
      time_remaining: "Tiempo restante de esta ventana de inicio de sesión:",
      saved_login_hint:
        "Inicia sesión en la ventana abierta. Tu sesión guardada se conserva; solo la limpieza de caché afecta a la caché.",
      verify_login: "Ya he iniciado sesión",
      extend: "Ampliar tiempo (10 min)",
      cancel_task: "Cancelar tarea",
      reasons: {
        login_required: "El sitio requiere iniciar sesión para continuar.",
        login_expired: "La sesión guardada ha caducado.",
        captcha_sensitive_flow: "Este paso necesita confirmación humana.",
        mfa_prompt: "El sitio solicitó autenticación multifactor.",
        passkey_prompt: "El sitio solicitó una clave de acceso.",
        password_field: "Un campo de contraseña debe completarlo tú.",
        recovery_flow: "La cuenta entró en un flujo de recuperación.",
        account_selection_ambiguous: "No está claro qué cuenta usar.",
        browser_permission_prompt:
          "El navegador pidió un permiso que solo tú puedes conceder.",
        destructive_action_unclear:
          "Esta acción podría ser destructiva y necesita tu confirmación.",
        repeated_action_failure:
          "El paso falló repetidamente; termínalo manualmente.",
        user_requested: "Pediste tomar el control de este paso.",
        challenge_unresolved:
          "Un desafío de verificación no pudo resolverse automáticamente.",
      },
    },
    settings: {
      title: "Navegador gestionado",
      description:
        "Controla el navegador social integrado que la IA usa para tareas con sesión iniciada y gestiona su caché.",
      browser_enabled: "Habilitar el navegador gestionado",
      active_session_title: "Hay sesiones del navegador activas",
      active_session_body:
        "Para desactivar el navegador gestionado debes decidir qué hacer con la sesión activa.",
      active_finish: "Terminar la sesión actual",
      clear_account_label: "Cuenta",
      clear_selected: "Limpiar la cuenta seleccionada",
      cache_phase_scanning: "Escaneando la caché…",
      cache_max_label: "Tamaño máximo de caché (MB)",
      clear_choice_stop: "Detener el navegador y limpiar ahora",
      clear_choice_defer: "Limpiar cuando se cierre el navegador",
      cache_phase_deleting: "Eliminando…",
      cache_phase_done: "Hecho",
      cache_phase_failed: "Fallido",
      active_stop_now: "Detener ahora",
      stop_failed:
        "No se pudo detener una sesión activa; el ajuste sigue habilitado. Reintenta o detén el navegador desde la tarjeta del chat.",
      ...
      last_cleared: "Limpiada por última vez {when}",
      clear_all: "Limpiar caché",
      clear_preserves_logins:
        "Limpiar la caché conserva tus inicios de sesión y datos de cuentas.",
      clear_confirm_title: "¿Limpiar la caché del navegador?",
      clear_confirm_body: "Se eliminarán unos {size} de archivos en caché.",
      clear_confirm_preserved:
        "Tus sesiones guardadas y datos de cuentas se conservan.",
      clear_confirm_ok: "Limpiar caché",
      disabled_reasons: {
        user_setting_disabled:
          "El navegador gestionado está desactivado en estos ajustes.",
        release_flag_disabled:
          "El navegador gestionado está desactivado temporalmente por una bandera de versión.",
      },
    },
  },
  ...
  // Salida de la aplicación y bandeja del sistema (PRD FR-08)
  applicationLifecycle: {
    ...
    activeTasks: "{n} tarea en ejecución. | {n} tareas en ejecución.",
