...
export default {
  ...
  messages_title: "Mensajes Recibidos",
   ...
   select_email_service_hint: "Seleccione un servicio de correo para ver los mensajes.",
  sync: "Sincronizar",
...
emailAutoReplyAudit: {
  ...
  socialaccount: {
    ...
    delete_tool_account_confirm_title: "Confirmar eliminación de cuenta de herramienta",
    ...
    save_success: "Guardado correctamente, el ID de la cuenta de herramienta es",
    save_fail: "Error al guardar",
  },
  video_download_list: {},
  system_settings: {
  ...
  aiProvider: {
    ...
    description: "Los proveedores personalizados pueden alimentar el AI Chat con tu propio modelo. Las funciones de IA alojada de aiFetchly siguen requiriendo una suscripción.",
    mode_hosted: "aiFetchly alojado",
    mode_local: "Proveedor personalizado / local",
    hosted_enabled: "La IA alojada de aiFetchly está habilitada para tu cuenta.",
    hosted_requires_subscription: "La IA alojada de aiFetchly requiere una suscripción.",
    ...
    saved_local: "Proveedor de IA local guardado. AI Chat ahora puede usar tu modelo configurado.",
    ...
    tool_warning: "Este proveedor local no ha confirmado la compatibilidad con herramientas. Las herramientas están deshabilitadas para esta conversación.",
  },
  aiArtifacts: {
  ...
  subagents: {
    ...
    readonly_plugin_hint: "Los subagentes de complemento son de solo lectura. Desactívalos o edita el código del complemento.",
    readonly_workspace_hint: "Los subagentes del espacio de trabajo son de solo lectura. Edita el archivo de agente del espacio de trabajo para cambiarlos.",
