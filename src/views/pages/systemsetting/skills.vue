<template>
  <AppPageShell
    page-id="settings-skills"
    title-key="route.skills_management"
    content-width="wide"
    :busy="isLoading"
  >
    <template #context>
      <button
        type="button"
        class="back-link"
        data-testid="settings-skills-back"
        @click="goBack"
      >
    ...
    <template #primary-action>
      <v-btn color="primary" data-testid="settings-skills-import" @click="triggerImport">
