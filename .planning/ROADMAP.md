...
- [ ] 15-02-source-wiring-argument-hint-PLAN.md — Global loader command scan + workspace draft→definition conversion + D-03 workspace-shadows-global + D-04 argumentHint inline in suggestions
