...
- [ ] **Route memory creation by storage mode** (`FR-013`, `FR-016`, `FR-024`, `FR-037`, `FR-043`, `FR-060`)
...
- [ ] **Route portable edits through the file-first service** (`FR-013`, `FR-016`, `FR-024`, `FR-029`, `FR-039`, `FR-043`, `AC-006`, `AC-007`)
...
- [ ] **Implement portable archive and contradict operations** (`FR-039`, `FR-040`, `FR-043`, `FR-060`)
...
- [ ] **Implement portable hard delete** (`FR-039`, `FR-042`, `FR-043`, `FR-060`)
...
- [ ] **Wire promotion and privatization into the memory UI** (`FR-038`, `FR-054`, `FR-060`)
...
- [ ] **Use one per-scope queue for every mutation** (`FR-024` through `FR-029`, technical design D-05/D-06)
...
- [ ] **Make app writes use the shared validator** (`FR-009`, `FR-013`, technical design sections 7 and 19)
...
- [ ] **Finish startup and branch/worktree reconciliation evidence** (`FR-026`, `AC-002`, `AC-009`)
...
- [ ] **Make conflict resolution race-safe** (`FR-029`, `FR-041`, `AC-007`)
...
- [ ] **Reject duplicate IDs without importing either ambiguous record** (`FR-009`, `FR-014`, `FR-028`)
...
- [ ] **Persist unknown-field warnings as diagnostics** (`FR-011`, `FR-030`)
...
- [ ] **Verify last-valid projection behavior end to end** (`FR-014`, `FR-028`, `AC-003`)
...
- [ ] **Add and verify the database baseline migration** (technical design sections 2.4, 9.1, 26, and 31)
...
- [ ] **Implement the specified transactional scope merge rules** (`FR-006`, `FR-067`, `FR-068`, `AC-004`, `AC-013`)
...
- [ ] **Make workspace-identity regeneration a safe fork operation** (`FR-007`, `AC-013`)
...
- [ ] **Always rebuild `INDEX.md` from the complete eligible record set** (`FR-031`, `FR-043`, `AC-001`)
...
- [ ] **Complete rollback and re-enable behavior** (`FR-054`, PRD section 19.4)
...
- [ ] **Add auto-dream portable review proposals** (`FR-040`, technical design section 19.5 and Phase E)
...
- [ ] **Remove untranslated renderer fallbacks and enforce locale parity** (`FR-066`)
...
- [ ] **Rewrite the portable-memory Playwright suite to operate the application** (`FR-065`)
...
- [ ] **E2E: enable and export** (`AC-001`, `AC-006`, `AC-009`)
...
- [ ] **E2E: external edit and invalid edit** (`AC-002`, `AC-003`)
...
- [ ] **E2E: concurrent edit and conflict resolution** (`AC-007`)
...
- [ ] **E2E: isolation, clone, fork, and revocation** (`AC-004`, `AC-005`, `AC-011`, `AC-013`)
...
- [ ] **E2E: bridge lifecycle and no publication** (`AC-008`, `AC-010`)
...
- [ ] **Add missing fault-injection and recovery suites** (`AC-006`, `AC-009`)
